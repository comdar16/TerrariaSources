...
namespace Terraria
{
	public class Dust
	{
		...
		public static void UpdateDust()
		{
			...
			for (int i = 0; i < 6000; i++)
			{
				...
				if (i < Main.maxDustToDraw)
				{
					...
					else if (dust.type >= 244 && dust.type <= 247)
					{
						...
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num70, num71, num72);
						}
					}
					...
					else if (dust.type == 15 || dust.type == 57 || dust.type == 58 || dust.type == 274 || dust.type == 292)
					{
						...
						if (!dust.noLightEmittence)
						{
							...
							if (dust.type == 15)
							{
								Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num80 * 0.45f, num80 * 0.55f, num80);
							}
							else if (dust.type == 57)
							{
								Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num80 * 0.95f, num80 * 0.95f, num80 * 0.45f);
							}
							else if (dust.type == 58)
							{
								Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num80, num80 * 0.55f, num80 * 0.75f);
							}
						}
					}
					...
					else if (dust.type == 110)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num81 * 0.2f, num81, num81 * 0.5f);
					}
					else if (dust.type == 111)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num82 * 0.2f, num82 * 0.7f, num82);
					}
					else if (dust.type == 112)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num83 * 0.8f, num83 * 0.2f, num83 * 0.8f);
					}
					else if (dust.type == 113)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num84 * 0.2f, num84 * 0.3f, num84 * 1.3f);
					}
					else if (dust.type == 114)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num85 * 1.2f, num85 * 0.5f, num85 * 0.4f);
					}
					else if (dust.type == 66)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num86 * ((float)(int)dust.color.R / 255f), num86 * ((float)(int)dust.color.G / 255f), num86 * ((float)(int)dust.color.B / 255f));
					}
					else if (dust.type == 267)
					{
						...
						if (!dust.noLight && !dust.noLightEmittence)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num87 * ((float)(int)dust.color.R / 255f), num87 * ((float)(int)dust.color.G / 255f), num87 * ((float)(int)dust.color.B / 255f));
						}
					}
					else if (dust.type == 20 || dust.type == 21 || dust.type == 231)
					{
						...
						{
							num88 = dust.scale * 0.4f;
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num88 * 0.8f, num88 * 0.3f, num88);
						}
						else if (dust.type == 231)
						{
							num88 = dust.scale * 0.4f;
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num88, num88 * 0.5f, num88 * 0.3f);
						}
						else
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num88 * 0.3f, num88 * 0.6f, num88);
						}
					}
					else if (dust.type == 27 || dust.type == 45)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num89 * 0.6f, num89 * 0.2f, num89);
					}
					else if (dust.type == 55 || dust.type == 56 || dust.type == 73 || dust.type == 74)
					{
						...
						if (!dust.noLightEmittence)
						{
							...
							if (dust.type == 55)
							{
								...
								Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num90, num90, num90 * 0.6f);
							}
							else if (dust.type == 73)
							{
								...
								Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num90, num90 * 0.35f, num90 * 0.5f);
							}
							else if (dust.type == 74)
							{
								...
								Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num90 * 0.35f, num90, num90 * 0.5f);
							}
							else
							{
								...
								Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num90 * 0.35f, num90 * 0.5f, num90);
							}
						}
					}
					else if (dust.type == 71 || dust.type == 72)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num91 * 0.2f, 0f, num91 * 0.1f);
					}
					...
					else if (dust.type == 270)
					{
						...
						{
							dust.velocity.Y = (float)Math.Sin(dust.position.X * 0.00439822953f) * 2f;
							dust.velocity.Y -= 3f;
							dust.velocity.Y /= 20f;
						}
					}
					...
					if (dust.type == 35 && dust.noGravity)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f + 1f), num92, num92 * 0.3f, num92 * 0.1f);
					}
					...
					else if (dust.type == 67 || dust.type == 92)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), 0f, num93 * 0.8f, num93);
					}
					else if (dust.type == 185)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num94 * 0.1f, num94 * 0.7f, num94);
					}
					else if (dust.type == 107)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num95 * 0.1f, num95, num95 * 0.4f);
					}
					...
					if (dust.type == 68)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num97 * 0.1f, num97 * 0.2f, num97);
					}
					if (dust.type == 70)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num98 * 0.5f, 0f, num98);
					}
					if (dust.type == 41)
					{
						...
						Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num99 * 0.4f, num99 * 0.9f, num99);
					}
					...
					if (dust.type >= 130 && dust.type <= 134)
					{
						...
						if (dust.type == 130)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num104 * 1f, num104 * 0.5f, num104 * 0.4f);
						}
						if (dust.type == 131)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num104 * 0.4f, num104 * 1f, num104 * 0.6f);
						}
						if (dust.type == 132)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num104 * 0.3f, num104 * 0.5f, num104 * 1f);
						}
						if (dust.type == 133)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num104 * 0.9f, num104 * 0.9f, num104 * 0.3f);
						}
						if (dust.noGravity)
						{
							dust.velocity *= 0.93f;
					...
					else if (dust.type == 278)
					{
						...
						if (!dust.noLight)
						{
							Lighting.AddLight(dust.position, dust.color.ToVector3() * num105);
						}
						if (dust.noGravity)
						{
							dust.velocity *= 0.93f;
					...
					else if (dust.type == 226)
					{
						...
						if (!dust.noLight)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num107 * 0.2f, num107 * 0.7f, num107 * 1f);
						}
						if (dust.noGravity)
						{
							dust.velocity *= 0.93f;
					...
					else if (dust.type == 272)
					{
						...
						if (!dust.noLight)
						{
							Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num108 * 0.5f, num108 * 0.2f, num108 * 0.8f);
						}
						if (dust.noGravity)
						{
							dust.velocity *= 0.93f;
			...
			int num110 = num;
			if ((double)num110 > (double)Main.maxDustToDraw * 0.9)
			{
				dCount = 0.9f;
			}
			else if ((double)num110 > (double)Main.maxDustToDraw * 0.8)
			{
				dCount = 0.8f;
			}
			else if ((double)num110 > (double)Main.maxDustToDraw * 0.7)
			{
				dCount = 0.7f;
			}
			else if ((double)num110 > (double)Main.maxDustToDraw * 0.6)
			{
				dCount = 0.6f;
			}
			else if ((double)num110 > (double)Main.maxDustToDraw * 0.5)
			{
				dCount = 0.5f;
			}
			else
		...
		public Color GetAlpha(Color newColor)
		{
			...
			if (type == 6 || type == 242 || type == 174 || type == 135 || type == 75 || type == 20 || type == 21 || type == 231 || type == 169 || (type >= 130 && type <= 134) || type == 158 || type == 293 || type == 294 || type == 295 || type == 296 || type == 297 || type == 298)
			{
				return new Color(newColor.R, newColor.G, newColor.B, 25);
			}
			if (type == 278)
			...
			{
				num7 = (num6 = (num5 = 255));
				float num8 = (float)(int)Main.mouseTextColor / 100f - 1.6f;
				...
				return new Color(num7, num6, num5, a2);
			}
			if (type == 284)
			{
			...
			num7 = (int)((float)(int)newColor.R * num);
			num6 = (int)((float)(int)newColor.G * num);
			num5 = (int)((float)(int)newColor.B * num);
			...
			return new Color(num7, num6, num5, num9);
		}
