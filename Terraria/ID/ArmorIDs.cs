	...
	public class ArmorIDs
	{
		...
		public class Body
		{
			public class Sets
			{
				...
				public static bool[] DisableBeltAccDraw;
				...
				static Sets()
				{
					...
					object[] obj = new object[6] { 85, null, null, null, null, null };
					...
					obj[3] = includeCapeFrontAndBackInfo;
					obj[4] = 236;
					includeCapeFrontAndBackInfo = new IncludeCapeFrontAndBackInfo
					{
						backCape = 31,
					...
					obj[5] = includeCapeFrontAndBackInfo;
					...
					showsShouldersWhileJumping = Factory.CreateBoolSet(177, 190, 95, 46, 73, 92, 24, 54, 55, 56, 65, 66, 67, 69, 70, 71, 75, 105, 106, 175, 176, 182, 183, 187, 194, 197, 198, 201, 204, 226, 227, 229, 239);
					shouldersAreAlwaysInTheBack = Factory.CreateBoolSet(190);
					DisableHandOnAndOffAccDraw = Factory.CreateBoolSet(83);
					DisableBeltAccDraw = Factory.CreateBoolSet(83, 82);
				}
			}
		...
		public class Face
		{
			public class Sets
			{
				...
				public static bool[] DrawInFaceFlowerLayer = Factory.CreateBoolSet(false, 1, 6, 9);
