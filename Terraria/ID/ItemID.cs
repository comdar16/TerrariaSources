...
namespace Terraria.ID
{
	public class ItemID
	{
		...
		public class Sets
		{
			...
			public static bool?[] CanBeQuickusedOnGamepad = Factory.CreateCustomSet<bool?>(null, new object[18]
			{
				(short)50,
				true,
				(short)3199,
			...
			public static bool[] CanGetPrefixes = Factory.CreateBoolSet(true, 267, 562, 563, 564, 565, 566, 567, 568, 569, 570, 571, 572, 573, 574, 576, 1307, 1596, 1597, 1598, 1599, 1600, 1601, 1602, 1603, 1604, 1605, 1606, 1607, 1608, 1609, 1610);
			...
			public static int[] KillsToBanner = Factory.CreateIntSet(50, 3838, 1000, 3845, 200, 3837, 500, 3844, 200, 3843, 50, 3839, 200, 3840, 100, 3842, 200, 3841, 100, 3846, 50, 2971, 200, 2982, 100, 2994, 100);
