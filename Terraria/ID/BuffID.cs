...
namespace Terraria.ID
{
	public class BuffID
	{
		public class Sets
		{
			...
			public static bool[] TimeLeftDoesNotDecrease = Factory.CreateBoolSet(28, 334);
			...
			public static bool[] NurseCannotRemoveDebuff = Factory.CreateBoolSet(28, 34, 87, 89, 21, 86, 199, 332, 333, 334, 165, 146, 48, 158, 157, 215, 147);

			public static BuffMountData[] BasicMountData = Factory.CreateCustomSet<BuffMountData>(null, new object[100]
			{
				118,
				new BuffMountData
				{
