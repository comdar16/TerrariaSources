...
namespace Terraria.GameContent.ItemDropRules
{
	public class ItemDropDatabase
	{
		...
		private void RegisterBloodMoonFishing()
		{
			...
			RegisterToMultipleNPCs(ItemDropRule.ByCondition(condition, 4271, 100), 489, 490, 109);
			RegisterToMultipleNPCs(ItemDropRule.ByCondition(condition, 4271, 25), 587, 586, 621, 620);
			RegisterToMultipleNPCs(ItemDropRule.ByCondition(condition, 4271, 5), 53, 536);
		}
		...
		private void RegisterEclipse()
		{
			...
			RegisterToNPC(467, new LeadingConditionRule(condition2)).OnSuccess(ItemDropRule.ExpertGetsRerolls(3249, 40, 1));
		...
		{
			IItemDropRule entry = ItemDropRule.OneFromOptions(1, 437, 517, 535, 536, 532, 554);
			RegisterToNPC(85, entry);
		...
		private void RegisterBoss_PumpkinMoon()
		{
			...
			RegisterToNPC(327, new LeadingConditionRule(condition2)).OnSuccess(new LeadingConditionRule(condition3)).OnSuccess(ItemDropRule.Common(1856));
			RegisterToNPC(325, new LeadingConditionRule(condition2)).OnSuccess(new LeadingConditionRule(condition3)).OnSuccess(ItemDropRule.Common(1855));
			...
			RegisterToNPC(325, ItemDropRule.ByCondition(condition2, 1729, 1, 30, 50));
			RegisterToNPC(326, ItemDropRule.ByCondition(condition2, 1729, 1, 1, 4));
		}
		...
		private void RegisterBoss_FrostMoon()
		{
			...
			rule2.OnSuccess(ItemDropRule.ByCondition(condition3, 1914, 30));
		...
		private void RegisterBoss_EOW()
		{
			...
			RegisterToMultipleNPCs(new DropBasedOnExpertMode(ItemDropRule.Common(86, 2, 1, 2), ItemDropRule.Common(86, 2, 2, 3)), npcNetIds);
			RegisterToMultipleNPCs(ItemDropRule.Common(56, 2, 2, 5), npcNetIds);
		...
		private void RegisterBoss_WOF()
		{
			...
			RegisterToNPC(type, new LeadingConditionRule(condition)).OnSuccess(new OneFromRulesRule(1, ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 490, 491, 489, 2998), ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 426, 434, 514, 4912)));
		}
		...
		private void RegisterGlobalRules()
		{
			...
			RegisterToGlobal(new ItemDropWithConditionRule(1314, 1000, 1, 1, new Conditions.KOCannon()));
		...
		private void RegisterDD2EventDrops()
		{
			...
			RegisterToNPC(576, ItemDropRule.NormalvsExpertOneFromOptionsNotScalingWithLuck(3, 2, 3809, 3811, 3810, 3812));
			RegisterToNPC(576, ItemDropRule.NormalvsExpertOneFromOptionsNotScalingWithLuck(3, 2, 3852, 3854, 3823, 3835, 3836));
			...
			RegisterToNPC(577, ItemDropRule.OneFromOptionsNotScalingWithLuck(6, 3809, 3811, 3810, 3812));
			RegisterToNPC(577, ItemDropRule.OneFromOptionsNotScalingWithLuck(6, 3852, 3854, 3823, 3835, 3836));
		...
		{
			RegisterToNPC(156, ItemDropRule.Common(1518, 75));
			RegisterToNPC(243, ItemDropRule.Common(1519, 3));
			RegisterToMultipleNPCs(ItemDropRule.Common(1517, 450), 269, 270, 271, 272, 273, 274, 275, 276, 277, 278, 279, 280);
			RegisterToMultipleNPCs(ItemDropRule.Common(1520, 40), 159, 158);
			RegisterToNPC(48, ItemDropRule.Common(1516, 200));
			RegisterToNPC(176, new ItemDropWithConditionRule(1521, 150, 1, 1, new Conditions.BeatAnyMechBoss()));
		...
		private void RegisterPirateDrops()
		{
			...
			RegisterToMultipleNPCs(ItemDropRule.Common(905, 8000), npcNetIds);
			RegisterToMultipleNPCs(ItemDropRule.Common(855, 4000), npcNetIds);
			RegisterToMultipleNPCs(ItemDropRule.Common(854, 2000), npcNetIds);
			RegisterToMultipleNPCs(ItemDropRule.Common(2584, 2000), npcNetIds);
			RegisterToMultipleNPCs(ItemDropRule.Common(3033, 1000), npcNetIds);
			...
			RegisterToMultipleNPCs(ItemDropRule.Common(3904, 150, 30, 50), npcNetIds);
			...
			RegisterToNPC(216, ItemDropRule.Common(905, 2000));
			RegisterToNPC(216, ItemDropRule.Common(855, 1000));
			RegisterToNPC(216, ItemDropRule.Common(854, 500));
			RegisterToNPC(216, ItemDropRule.Common(2584, 500));
			RegisterToNPC(216, ItemDropRule.Common(3033, 250));
			RegisterToNPC(216, ItemDropRule.Common(672, 50));
			RegisterToNPC(491, ItemDropRule.Common(905, 400));
			RegisterToNPC(491, ItemDropRule.Common(855, 200));
			RegisterToNPC(491, ItemDropRule.Common(854, 100));
			RegisterToNPC(491, ItemDropRule.Common(2584, 100));
			RegisterToNPC(491, ItemDropRule.Common(3033, 50));
		...
		private void RegisterMartianDrops()
		{
			...
			RegisterToNPC(390, ItemDropRule.Common(2771, 100));
		}
		...
		private void RegisterMiscDrops()
		{
			...
			RegisterToNPC(156, ItemDropRule.Common(683, 30));
			...
			RegisterToNPC(153, ItemDropRule.Common(1328, 17));
			...
			RegisterToNPC(49, ItemDropRule.Common(1325, 250));
			RegisterToNPC(634, ItemDropRule.Common(4764, 100));
			RegisterToNPC(185, ItemDropRule.Common(951, 150));
			RegisterToNPC(185, new DropBasedOnExpertMode(ItemDropRule.Common(5070, 2, 1, 3), new CommonDrop(5070, 10, 1, 3, 9)));
			...
			RegisterToNPC(24, ItemDropRule.Common(1323, 50));
			RegisterToNPC(109, ItemDropRule.Common(1324, 30, 1, 4));
			...
			RegisterToMultipleNPCs(ItemDropRule.Common(1306, 180), 197, 206, 169, 154);
			...
			RegisterToMultipleNPCs(ItemDropRule.OneFromOptions(50, 803, 804, 805), 161, 431);
			...
			RegisterToMultipleNPCs(new ItemDropWithConditionRule(5091, 200, 1, 1, new Conditions.DontStarveIsUp()), 6, 7, 8, 9, 94, 81, 121, 101, 173, 181, 239, 240, 174, 183, 242, 241, 268, 182, 98, 99, 100);
			RegisterToMultipleNPCs(new ItemDropWithConditionRule(5091, 1000, 1, 1, new Conditions.DontStarveIsNotUp()), 6, 7, 8, 9, 94, 81, 121, 101, 173, 181, 239, 240, 174, 183, 242, 241, 268, 182, 98, 99, 100);
			...
			RegisterToNPC(481, ItemDropRule.Common(4463, 40));
			...
			RegisterToNPC(65, ItemDropRule.Common(268, 50)).OnFailedRoll(ItemDropRule.Common(319));
			...
			RegisterToNPC(631, ItemDropRule.Common(4761, 20));
