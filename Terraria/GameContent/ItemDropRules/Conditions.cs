	...
	public class Conditions
	{
		...
		public class FrostMoonDropGatingChance : IItemDropRuleCondition, IProvideItemConditionDescription
		{
			public bool CanDrop(DropAttemptInfo info)
			{
				...
				int num2 = (int)((double)(30 - num) / 2.5);
				if (Main.expertMode)
				{
					num2 -= 2;
				}
		...
		public class PumpkinMoonDropGatingChance : IItemDropRuleCondition, IProvideItemConditionDescription
		{
			public bool CanDrop(DropAttemptInfo info)
			{
				...
				int num2 = (int)((double)(17 - num) / 1.25);
				if (Main.expertMode)
				{
					num2--;
				}
		...
		public class KOCannon : IItemDropRuleCondition, IProvideItemConditionDescription
		{
			public bool CanDrop(DropAttemptInfo info)
			{
				if (Main.hardMode && Main.bloodMoon && info.npc.value > 0f)
				{
					return !info.IsInSimulation;
				}
				return false;
			...
			public string GetConditionDescription()
			{
				return Language.GetTextValue("Bestiary_ItemDropConditions.KOCannon");
			}
		}
		...
		public class TenthAnniversaryIsUp : IItemDropRuleCondition, IProvideItemConditionDescription
		{
			...
			public string GetConditionDescription()
			{
				return Language.GetTextValue("Bestiary_ItemDropConditions.Is10thAnniverary");
			}
		}
		...
		public class DontStarveIsUp : IItemDropRuleCondition, IProvideItemConditionDescription
		{
			...
			public string GetConditionDescription()
			{
				return Language.GetTextValue("Bestiary_ItemDropConditions.IsDontStarve");
			}
		}
