...
namespace Terraria.GameContent.RGB
{
	...
	{
		// Token: 0x06001D07 RID: 7431 RVA: 0x004CF34C File Offset: 0x004CD54C
		private VirtualKeyboard(Fragment fragment, Keys[] keyMap) : base(RgbDeviceVendor.Virtual, fragment, new DeviceColorProfile())
		{
		...
		// Token: 0x06001D08 RID: 7432 RVA: 0x004CF394 File Offset: 0x004CD594
		...
		// Token: 0x06001D09 RID: 7433 RVA: 0x000392B0 File Offset: 0x000374B0
		public override void Present()
		{
		}

		// Token: 0x06001D0A RID: 7434 RVA: 0x004D0ABC File Offset: 0x004CECBC
		public override void Render(IEnumerable<RgbKey> keys)
		{
			foreach (RgbKey rgbKey in keys)
			{
				int index;
				if (this._keyCodeMap.TryGetValue(rgbKey.Key, out index))
				{
					base.SetLedColor(index, rgbKey.CurrentColor.ToVector4());
				}
			}
		}
