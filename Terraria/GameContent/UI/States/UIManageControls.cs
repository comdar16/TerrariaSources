...
namespace Terraria.GameContent.UI.States
{
	public class UIManageControls : UIState
	{
		...
		{
			"Throw", "Inventory", "RadialHotbar", "RadialQuickbar", "LockOn", "ToggleCreativeMenu", "sp3", "sp4", "sp5", "sp6",
			"sp7", "sp8", "sp18", "sp19", "sp9", "sp10", "sp11", "sp12", "sp13"
		};
		...
		private void AssembleBindPanels()
		{
			List<string> bindings = new List<string>
			{
				...
				"QuickMount", "QuickHeal", "QuickMana", "QuickBuff", "Throw", "Inventory", "ToggleCreativeMenu", "ViewZoomIn", "ViewZoomOut", "sp9"
			};
