	...
	public class TileDrawing
	{
		...
		private void MakeExtraPreparations(Tile tile, int x, int y)
		{
			...
			case 5:
			{
				...
				if (WorldGen.GetCommonTreeFoliageData(x, y, xoffset, ref treeFrame, ref treeStyle, out floorY, out topTextureFrameWidth, out topTextureFrameHeight))
				{
		...
		private void DrawSingleTile(TileDrawInfo drawData, bool solidLayer, int waterStyleOverride, Vector2 screenPosition, Vector2 screenOffset, int tileX, int tileY)
		{
			...
			if (Main.tileGlowMask[drawData.tileCache.type] != -1)
			{
				...
				case 129:
				{
					...
					{
						Main.spriteBatch.Draw(drawData.drawTexture, vector + num9.ToRotationVector2() * 2f, new Rectangle(drawData.tileFrameX + drawData.addFrX, drawData.tileFrameY + drawData.addFrY + num8, drawData.tileWidth, drawData.tileHeight), color2, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
					}
				...
				if (!flag)
				{
					...
					else
					{
						...
						for (int i = 0; i < 8; i++)
						{
							...
							Main.spriteBatch.Draw(drawData.drawTexture, new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + (float)num11, tileY * 16 - (int)screenPosition.Y + i * 2) + screenOffset, value, color2, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
						}
					}
				}
			}
			...
			else if (Main.tileFlame[drawData.typeCache])
			{
				...
				case 7:
				{
					for (int k = 0; k < 4; k++)
					{
						...
						float num12 = (float)Utils.RandomInt(ref seed, -10, 10) * 0.15f;
						num11 = 0f;
						num12 = 0f;
				...
				case 1:
					...
					case 10:
					{
						...
						{
							float num92 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.075f;
							float num93 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.075f;
					...
					case 8:
					{
						...
						{
							float num98 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.3f;
					...
					case 12:
					{
						...
						{
							float num86 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.1f;
							float num87 = (float)Utils.RandomInt(ref seed, -10, 1) * 0.15f;
					...
					case 14:
					{
						...
						{
							float num95 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.1f;
							float num96 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.1f;
					...
					case 16:
					{
						...
						{
							float num89 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.15f;
							float num90 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.15f;
					...
					default:
					{
						...
						{
							float num83 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.15f;
							float num84 = (float)Utils.RandomInt(ref seed, -10, 1) * 0.35f;
				...
				case 2:
					...
					case 3:
					{
						...
						{
							float num74 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.05f;
							float num75 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.15f;
					...
					case 6:
					{
						...
						{
							float num80 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.15f;
							float num81 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.15f;
					...
					case 9:
					{
						...
						{
							float num68 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.3f;
							float num69 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.3f;
					...
					case 11:
					{
						...
						{
							float num77 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.1f;
							float num78 = (float)Utils.RandomInt(ref seed, -10, 1) * 0.15f;
					...
					case 13:
					{
						...
						{
							float num71 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.1f;
							float num72 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.1f;
					...
					default:
					{
						...
						{
							float num65 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.15f;
							float num66 = (float)Utils.RandomInt(ref seed, -10, 1) * 0.35f;
				...
				case 3:
					...
					case 8:
					{
						...
						{
							float num59 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.075f;
							float num60 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.075f;
					...
					case 9:
					{
						...
						{
							float num47 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.05f;
							float num48 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.15f;
					...
					case 11:
					{
						...
						{
							float num53 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.3f;
							float num54 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.3f;
					...
					case 15:
					{
						...
						{
							float num62 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.1f;
							float num63 = (float)Utils.RandomInt(ref seed, -10, 1) * 0.15f;
					...
					case 20:
					{
						...
						{
							float num56 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.075f;
							float num57 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.075f;
					...
					case 18:
					{
						...
						{
							float num50 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.1f;
							float num51 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.1f;
					...
					default:
					{
						...
						{
							float num44 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.15f;
							float num45 = (float)Utils.RandomInt(ref seed, -10, 1) * 0.35f;
				...
				case 4:
					...
					case 1:
					{
						...
						{
							float num38 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.15f;
					...
					case 4:
					{
						...
						{
							float num24 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.075f;
							float num25 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.075f;
					...
					case 3:
					{
						...
						{
							float num32 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.2f;
							float num33 = (float)Utils.RandomInt(ref seed, -20, 1) * 0.35f;
					...
					case 5:
					{
						...
						{
							float num41 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.3f;
							float num42 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.3f;
					...
					case 9:
					{
						...
						{
							float num35 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.1f;
							float num36 = (float)Utils.RandomInt(ref seed, -10, 1) * 0.15f;
					...
					case 13:
					{
						...
						{
							float num29 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.1f;
							float num30 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.1f;
					...
					default:
					{
						for (int num20 = 0; num20 < 7; num20++)
						{
							...
							float num22 = (float)Utils.RandomInt(ref seed, -10, 1) * 0.35f;
				...
				case 13:
				{
					...
					case 39:
					{
						for (int n = 0; n < 7; n++)
						{
							...
							float num19 = (float)Utils.RandomInt(ref seed, -10, 1) * 0.35f;
					...
					case 25:
					{
						for (int m = 0; m < 7; m++)
						{
							...
							float num17 = (float)Utils.RandomInt(ref seed, -10, 1) * 0.1f;
					...
					default:
						...
						case 29:
						{
							for (int l = 0; l < 7; l++)
							{
								float num14 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.15f;
								float num15 = (float)Utils.RandomInt(ref seed, -10, 1) * 0.15f;
				...
				default:
				{
					for (int j = 0; j < 7; j++)
					{
						...
						float num9 = (float)Utils.RandomInt(ref seed, -10, 11) * 0.15f;
						float num10 = (float)Utils.RandomInt(ref seed, -10, 1) * 0.35f;
		...
		private void DrawTile_LiquidBehindTile(bool solidLayer, int waterStyleOverride, Vector2 screenPosition, Vector2 screenOffset, int tileX, int tileY, TileDrawInfo drawData)
		{
			...
			if ((!flag3 || !(flag || flag2)) && !(flag4 && flag3))
			{
				...
				else
				{
					...
					if (drawData.tileCache.slope() != 0)
					{
						vector = new Vector2(tileX * 16, tileY * 16 + (int)num5 * 2);
					...
					{
						vector = new Vector2(tileX * 16 + 12, tileY * 16 + (int)num5 * 2);
						liquidSize = new Rectangle(0, y, 4, 16 - (int)num5 * 2);
					}
				}
			}
			...
			if (flag6)
			{
				for (int i = 0; i < 13; i++)
				{
					...
					{
						DrawPartialLiquid(drawData.tileCache, vector - screenPosition + screenOffset, liquidSize, i, color);
						flag7 = true;
						break;
					}
				}
			}
			DrawPartialLiquid(drawData.tileCache, vector - screenPosition + screenOffset, liquidSize, num2, color * (flag7 ? Main.liquidAlpha[num2] : 1f));
		}
		...
		private void GetTileDrawData(int x, int y, Tile tileCache, ushort typeCache, ref short tileFrameX, ref short tileFrameY, out int tileWidth, out int tileHeight, out int tileTop, out int halfBrickHeight, out int addFrX, out int addFrY, out SpriteEffects tileSpriteEffect, out Texture2D glowTexture, out Rectangle glowSourceRect, out Color glowColor)
		{
			...
			case 518:
			{
				int num49 = (int)tileCache.liquid / 16;
				num49 -= 3;
				if (WorldGen.SolidTile(x, y - 1) && num49 > 8)
				{
					num49 = 8;
				}
				if (tileCache.liquid == 0)
				{
					...
					if (tileSafely.nactive())
					{
						...
						{
						case 1:
							num49 = -16 + Math.Max(8, (int)tileSafely.liquid / 16);
							break;
						case 2:
						case 3:
							num49 -= 4;
			...
			case 530:
			{
				int num20 = y - tileFrameY % 36 / 18 + 2;
				int num21 = x - tileFrameX % 54 / 18;
				WorldGen.GetBiomeInfluence(num21, num21 + 3, num20, num20, out var corruptCount, out var crimsonCount, out var hallowedCount);
				int num22 = corruptCount;
				if (num22 < crimsonCount)
				{
					num22 = crimsonCount;
				}
				if (num22 < hallowedCount)
				{
					num22 = hallowedCount;
				}
				int num23 = 0;
				num23 = ((corruptCount != 0 || crimsonCount != 0 || hallowedCount != 0) ? ((hallowedCount == num22) ? 1 : ((crimsonCount != num22) ? 3 : 2)) : 0);
				addFrY += 36 * num23;
				tileTop = 2;
				break;
			}
			...
			case 489:
			{
				...
				if (InAPlaceWithWind(num38, num37, 2, 3))
				{
			...
			{
				int num28 = y + 1;
				WorldGen.GetBiomeInfluence(x, x, num28, num28, out var corruptCount2, out var crimsonCount2, out var hallowedCount2);
				int num29 = corruptCount2;
				if (num29 < crimsonCount2)
				{
					num29 = crimsonCount2;
				}
				if (num29 < hallowedCount2)
				{
					num29 = hallowedCount2;
				}
				int num30 = 0;
				num30 = ((corruptCount2 == 0 && crimsonCount2 == 0 && hallowedCount2 == 0) ? ((x < WorldGen.beachDistance || x > Main.maxTilesX - WorldGen.beachDistance) ? 1 : 0) : ((hallowedCount2 == num29) ? 2 : ((crimsonCount2 != num29) ? 4 : 3)));
				addFrY += 34 * num30 - tileFrameY;
				tileHeight = 32;
				tileTop = -14;
				if (x % 2 == 0)
				{
			...
			case 493:
				if (tileFrameY == 0)
				{
					int num16 = Main.tileFrameCounter[typeCache];
					float num17 = Math.Abs(Main.WindForVisuals);
					int num18 = y - tileFrameY / 18;
					int num19 = x - tileFrameX / 18;
					if (!InAPlaceWithWind(x, num18, 1, 1))
					{
						num17 = 0f;
					}
					if (!(num17 < 0.1f))
					{
						if (num17 < 0.5f)
						{
							...
							num16 += num18 + num19;
							num16 %= 6;
							num16 = ((!(Main.WindForVisuals < 0f)) ? (num16 + 1) : (6 - num16));
							addFrY = num16 * 36;
						}
						else
						{
							...
							num16 += num18 + num19;
							num16 %= 6;
							num16 = ((!(Main.WindForVisuals < 0f)) ? (num16 + 7) : (12 - num16));
							addFrY = num16 * 36;
						}
					}
				}
			...
			case 594:
			{
				...
				tileTop = 2;
				int num31 = tileFrameX % 36;
				int num32 = tileFrameY % 36;
				if (Animation.GetTemporaryFrame(x - num31 / 18, y - num32 / 18, out var frameData3))
				{
			...
			case 581:
			{
				int num15 = Main.tileFrame[typeCache] + x % 6;
				if (x % 2 == 0)
				{
					num15 += 3;
				}
			...
			{
				int num14;
				for (num14 = Main.tileFrame[typeCache] + x % 4; num14 > 3; num14 -= 4)
				{
				}
				addFrX = num14 * 18;
				addFrY = 0;
		...
		private void DrawTiles_EmitParticles(int j, int i, Tile tileCache, ushort typeCache, short tileFrameX, short tileFrameY, Color tileLight)
		{
			...
			if (typeCache == 565 && tileFrameX == 0 && tileFrameY == 18 && _rand.Next(3) == 0 && ((Main.drawToScreen && _rand.Next(4) == 0) || !Main.drawToScreen))
			{
				...
				Vector2 position2 = vector + new Vector2(0f, -18f);
			...
			{
				int num11 = tileCache.frameY / 22;
				int num12 = TorchID.Dust[num11];
				int num13 = 0;
				switch (tileFrameX)
				{
				case 22:
					num13 = Dust.NewDust(new Vector2(i * 16 + 6, j * 16), 4, 4, num12, 0f, 0f, 100);
					break;
				case 44:
					num13 = Dust.NewDust(new Vector2(i * 16 + 2, j * 16), 4, 4, num12, 0f, 0f, 100);
					break;
				default:
					num13 = Dust.NewDust(new Vector2(i * 16 + 4, j * 16), 4, 4, num12, 0f, 0f, 100);
					break;
				}
				if (_rand.Next(3) != 0)
				{
					_dust[num13].noGravity = true;
				}
				_dust[num13].velocity *= 0.3f;
				_dust[num13].velocity.Y -= 1.5f;
				if (num12 == 66)
				{
					_dust[num13].color = new Color(Main.DiscoR, Main.DiscoG, Main.DiscoB);
					_dust[num13].noGravity = true;
				}
			}
			if (typeCache == 93 && _rand.Next(40) == 0 && tileFrameX == 0)
			{
				int num14 = tileFrameY / 54;
				if (tileFrameY / 18 % 3 == 0)
				{
					...
					if (num15 != -1)
					{
						int num16 = Dust.NewDust(new Vector2(i * 16 + 4, j * 16 + 2), 4, 4, num15, 0f, 0f, 100);
						if (_rand.Next(3) != 0)
						{
			...
			if (typeCache == 100 && _rand.Next(40) == 0 && tileFrameX < 36)
			{
				...
				if (tileFrameY / 18 % 2 == 0)
				{
					...
					{
						int num19 = 0;
						Vector2 position3 = ((tileFrameX == 0) ? ((_rand.Next(3) != 0) ? new Vector2(i * 16 + 14, j * 16 + 2) : new Vector2(i * 16 + 4, j * 16 + 2)) : ((_rand.Next(3) != 0) ? new Vector2(i * 16, j * 16 + 2) : new Vector2(i * 16 + 6, j * 16 + 2)));
						num19 = Dust.NewDust(position3, 4, 4, num18, 0f, 0f, 100);
						if (_rand.Next(3) != 0)
						{
			...
			{
				int num20 = Dust.NewDust(new Vector2(i * 16 + 12, j * 16 + 2), 4, 4, 6, 0f, 0f, 100);
				if (_rand.Next(3) != 0)
				{
			...
			{
				int num21 = Dust.NewDust(new Vector2(i * 16 + 4, j * 16 - 4), 4, 4, 172, 0f, 0f, 100);
				if (_rand.Next(3) == 0)
				{
			...
			{
				int num22 = Dust.NewDust(new Vector2(i * 16 + 4, j * 16 - 4), 4, 4, 242, 0f, 0f, 100);
				if (_rand.Next(3) == 0)
				{
					_dust[num22].scale = 0.5f;
				}
				else
				{
					_dust[num22].scale = 0.9f;
			...
			if (typeCache == 34 && _rand.Next(40) == 0 && tileFrameX < 54)
			{
				...
				int num24 = tileFrameX / 18 % 3;
				if (tileFrameY / 18 % 3 == 1 && num24 != 1)
				{
					int num25;
					switch (num23)
					{
					...
					if (num25 != -1)
					{
						int num26 = Dust.NewDust(new Vector2(i * 16, j * 16 + 2), 14, 6, num25, 0f, 0f, 100);
						if (_rand.Next(3) != 0)
						{
							_dust[num26].noGravity = true;
						}
						_dust[num26].velocity *= 0.3f;
						_dust[num26].velocity.Y -= 1.5f;
					}
				}
			}
			...
			else if (typeCache == 31 && _rand.Next(20) == 0)
			{
				if (tileFrameX >= 36)
				{
					...
					_dust[num27].velocity.Y = 0f;
					_dust[num27].velocity.X *= 0.3f;
				}
				else
				{
			...
			else if (typeCache == 26 && _rand.Next(20) == 0)
			{
				if (tileFrameX >= 54)
				{
					int num28 = Dust.NewDust(new Vector2(i * 16, j * 16), 16, 16, 5, 0f, 0f, 100);
					_dust[num28].scale = 1.5f;
					_dust[num28].noGravity = true;
					_dust[num28].velocity *= 0.75f;
				}
				else
				{
					Dust.NewDust(new Vector2(i * 16, j * 16), 16, 16, 14, 0f, 0f, 100);
			...
			else if ((typeCache == 17 || typeCache == 77 || typeCache == 133) && _rand.Next(40) == 0)
			{
				...
				{
					int num29 = Dust.NewDust(new Vector2(i * 16 - 4, j * 16 - 6), 8, 6, 6, 0f, 0f, 100);
					if (_rand.Next(3) != 0)
					{
			...
			else if (typeCache == 405 && _rand.Next(20) == 0)
			{
				if (tileFrameX == 18 && tileFrameY == 18)
				{
					int num30 = Dust.NewDust(new Vector2(i * 16 - 4, j * 16 - 6), 24, 10, 6, 0f, 0f, 100);
					if (_rand.Next(5) != 0)
					{
			...
			else if ((typeCache == 58 || typeCache == 76) && _rand.Next(250) == 0)
			{
				...
				_dust[num33].noLight = true;
			}
			else if (typeCache == 61)
			{
				if (tileFrameX == 144 && _rand.Next(60) == 0)
				{
					int num34 = Dust.NewDust(new Vector2(i * 16, j * 16), 16, 16, 44, 0f, 0f, 250, default(Color), 0.4f);
					_dust[num34].fadeIn = 0.7f;
				}
			}
			else
			{
				...
				int num35 = tileLight.R;
				if (tileLight.G > num35)
				{
					num35 = tileLight.G;
				}
				if (tileLight.B > num35)
				{
					num35 = tileLight.B;
				}
				num35 /= 30;
				if (_rand.Next(Main.tileShine[typeCache]) >= num35 || ((typeCache == 21 || typeCache == 441) && (tileFrameX < 36 || tileFrameX >= 180) && (tileFrameX < 396 || tileFrameX > 409)) || ((typeCache == 467 || typeCache == 468) && (tileFrameX < 144 || tileFrameX >= 180)))
				{
					return;
				}
		...
		private void DrawSpecialTilesLegacy(Vector2 screenPosition, Vector2 offSet)
		{
			for (int i = 0; i < _specialTilesCount; i++)
			{
				...
				if (type == 412)
				{
					...
					Main.spriteBatch.Draw(value7, new Vector2(num * 16 - (int)screenPosition.X, num2 * 16 - (int)screenPosition.Y + 10) + offSet, value7.Frame(1, 4, 0, num10), color5 * (1f - num11), 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
					Main.spriteBatch.Draw(value7, new Vector2(num * 16 - (int)screenPosition.X, num2 * 16 - (int)screenPosition.Y + 10) + offSet, value7.Frame(1, 4, 0, frameY2), color5 * num11, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
				}
				if (type == 620)
				{
					Texture2D value8 = TextureAssets.Extra[202].Value;
					...
					int num15 = 6;
					float num16 = 1f;
					Rectangle value9 = new Rectangle(0, 34 * num14, 32, 32);
					Vector2 vector = new Vector2(num * 16 - (int)screenPosition.X, num2 * 16 - (int)screenPosition.Y + num12) + offSet;
					Main.spriteBatch.Draw(value8, vector, value9, new Color(255, 255, 255, 255), 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
					for (int j = 0; j < num15; j++)
					{
						...
						Main.spriteBatch.Draw(value8, position2, value9, color6, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
					}
					Main.spriteBatch.Draw(value8, vector, value9, new Color(255, 255, 255, 0) * 0.1f, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
				}
			}
		}
				...
				try
				{
					...
					if (flag2 && frameY >= 198 && frameX >= 22)
					{
						...
						case 22:
						{
							...
							int floorY2 = y;
							if (!getTreeFoliageDataMethod(x, y, num9, ref treeFrame, ref treeStyle2, out floorY2, out topTextureFrameWidth2, out topTextureFrameHeight2))
							{
								continue;
							}
						...
						case 44:
						{
							...
							int floorY3 = y;
							int num13 = 1;
							if (!getTreeFoliageDataMethod(x, y, num13, ref treeFrame, ref treeStyle3, out floorY3, out var _, out var _))
							{
								continue;
							}
							...
							Vector2 position3 = new Vector2(x * 16, y * 16) - unscaledPosition.Floor() + zero + new Vector2(16f, 12f);
							float num15 = 0f;
							if (!flag)
							{
		...
		private void DrawGrass()
		{
			...
			for (int i = 0; i < num2; i++)
			{
				...
				GetTileDrawData(x, y, tile, type, ref tileFrameX, ref tileFrameY, out var tileWidth, out var tileHeight, out var tileTop, out var halfBrickHeight, out var addFrX, out var addFrY, out var tileSpriteEffect, out var _, out var _, out var _);
		...
		private void DrawTeleportationPylons()
		{
			...
			for (int i = 0; i < num2; i++)
			{
				...
				for (float num7 = 0f; num7 < 1f; num7 += 355f / (678f * (float)Math.PI))
				{
		...
		private void DrawVineStrip(Vector2 screenPosition, Vector2 offSet, int x, int startY)
		{
			...
			for (int i = startY; i < Main.maxTilesY - 10; i++)
			{
				...
				if (tile != null)
				{
					...
					GetTileDrawData(x, i, tile, type, ref tileFrameX, ref tileFrameY, out var tileWidth, out var tileHeight, out var tileTop, out var halfBrickHeight, out var addFrX, out var addFrY, out var tileSpriteEffect, out var _, out var _, out var _);
		...
		private void DrawMultiTileVinesInWind(Vector2 screenPosition, Vector2 offSet, int topLeftX, int topLeftY, int sizeX, int sizeY)
		{
			...
			for (int i = topLeftX; i < topLeftX + sizeX; i++)
			{
				for (int j = topLeftY; j < topLeftY + sizeY; j++)
				{
					...
					Vector2 origin = vector - vector3;
					Texture2D tileDrawTexture = GetTileDrawTexture(tile2, i, j);
					if (tileDrawTexture != null)
					{
						Vector2 vector5 = vector + new Vector2(0f, vector4.Y);
						Rectangle value = new Rectangle(tileFrameX + addFrX, tileFrameY + addFrY, tileWidth, tileHeight - halfBrickHeight);
						float rotation = windCycle * num2 * num7;
						Main.spriteBatch.Draw(tileDrawTexture, vector5, value, tileLight, rotation, origin, 1f, tileSpriteEffect, 0f);
						if (texture2D != null)
						{
							Main.spriteBatch.Draw(texture2D, vector5, value, color, rotation, origin, 1f, tileSpriteEffect, 0f);
						}
						...
						for (int k = 0; k < tileFlameData.flameCount; k++)
						{
							float x = (float)Utils.RandomInt(ref tileFlameData.flameSeed, tileFlameData.flameRangeXMin, tileFlameData.flameRangeXMax) * tileFlameData.flameRangeMultX;
							float y = (float)Utils.RandomInt(ref tileFlameData.flameSeed, tileFlameData.flameRangeYMin, tileFlameData.flameRangeYMax) * tileFlameData.flameRangeMultY;
							Main.spriteBatch.Draw(tileFlameData.flameTexture, vector5 + new Vector2(x, y), value, tileFlameData.flameColor, rotation, origin, 1f, tileSpriteEffect, 0f);
						}
					}
				}
			}
