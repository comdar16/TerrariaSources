	...
	public class CreativePowers
	{
		...
		public class DifficultySliderPower : ASharedSliderPower, IPersistentPerWorldContent
		{
			...
			public override UIElement ProvideSlider()
			{
				...
				AddIndication(uIPanel, 0f, "x3", "Images/UI/WorldCreation/IconDifficultyMaster", MouseOver_Master);
				AddIndication(uIPanel, 0.333333343f, "x2", "Images/UI/WorldCreation/IconDifficultyExpert", MouseOver_Expert);
				AddIndication(uIPanel, 2f / 3f, "x1", "Images/UI/WorldCreation/IconDifficultyNormal", MouseOver_Normal);
				AddIndication(uIPanel, 1f, "x0.5", "Images/UI/WorldCreation/IconDifficultyCreative", MouseOver_Journey);
				return uIPanel;
			}

			private static void AddIndication(UIPanel panel, float yAnchor, string indicationText, string iconImagePath, UIElement.ElementEvent updateEvent)
			{
		...
		public class ModifyWindDirectionAndStrength : ASharedSliderPower
		{
			...
			public override UIElement ProvideSlider()
			{
				...
				uIPanel.Append(uIVerticalSlider);
				uIPanel.OnUpdate += CreativePowersHelper.UpdateUseMouseInterface;
				UIText element = new UIText(Language.GetText("CreativePowers.WindWest"))
				{
					HAlign = 1f,
					VAlign = 0f
				};
		...
		public class ModifyRainPower : ASharedSliderPower
		{
			...
			public override UIElement ProvideSlider()
			{
				...
				uIPanel.Append(uIVerticalSlider);
				uIPanel.OnUpdate += CreativePowersHelper.UpdateUseMouseInterface;
				UIText element = new UIText(Language.GetText("CreativePowers.WeatherMonsoon"))
				{
					HAlign = 1f,
					VAlign = 0f
				};
