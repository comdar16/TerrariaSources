...
namespace Terraria.GameContent.Biomes.CaveHouse
{
	public class MarbleHouseBuilder : HouseBuilder
	{
		...
		{
			WorldUtils.Gen(new Point(room.X, room.Y), new Shapes.Rectangle(room.Width, room.Height), Actions.Chain(new Modifiers.Dither(0.60000002384185791), new Modifiers.Blotches(2, 0.60000002384185791), new Modifiers.OnlyTiles(base.TileType), new Actions.SetTileKeepWall(367, setSelfFrames: true)));
