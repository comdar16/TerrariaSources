		...
		public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
		{
			...
			for (int k = num; k < num2; k++)
			{
				if (_balloons[k].Active)
				{
					...
					Vector2 vector3 = _balloons[k].Position;
					...
					{
						spriteBatch.Draw(_balloons[k].Texture, vector3, _balloons[k].GetSourceRectangle(), color * _opacity, 0f, Vector2.Zero, vector2.X * 2f, SpriteEffects.None, 0f);
					}
				}
			}
		}
