	...
	public class LegacyLighting : ILightingEngine
	{
		...
		private void DoColors()
		{
			...
			for (int i = num; i < num2; i++)
			{
				...
				ParallelForAction val;
				switch (Mode)
				{
				case 0:
					val = new ParallelForAction(doColors_Mode0_Swipe);
					break;
				case 1:
					val = new ParallelForAction(doColors_Mode1_Swipe);
					break;
				case 2:
					val = new ParallelForAction(doColors_Mode2_Swipe);
					break;
				case 3:
					val = new ParallelForAction(doColors_Mode3_Swipe);
					break;
				default:
					val = new ParallelForAction(doColors_Mode0_Swipe);
					break;
				}
				FastParallel.For(num3, num4, val, (object)_swipe);
