...
namespace Terraria.Social.WeGame
{
	public class NetClientSocialModule : NetSocialModule
	{
		...
		public void OnRailEvent(RAILEventID id, EventBase data)
		{
			...
			WeGameHelper.WriteDebugString("OnRailEvent,id=" + ((object)(RAILEventID)(id)).ToString() + " ,result=" + ((object)(RailResult)(data.result)).ToString());
			if ((int)id <= 12010)
			{
				if ((int)id != 12002)
				{
		...
		{
			WeGameHelper.WriteDebugString("OnRailSetMetaData - " + ((object)(RailResult)(((EventBase)data).result)).ToString());
		}
