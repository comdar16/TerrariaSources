...
namespace Terraria.Map
{
	public static class MapHelper
	{
		...
		public static void Initialize()
		{
			...
			array3[142][0] = new Color(222, 216, 202);
			...
			int num7 = 0;
			tileOptionCounts = new int[625];
			for (int num8 = 0; num8 < 625; num8++)
			{
			...
			tileLookup = new ushort[625];
			for (int num13 = 0; num13 < 625; num13++)
			{
			...
			if (tile.active())
			{
				...
				else
				{
					...
					if (num3 != 0)
					{
						...
						GetTileBaseOption(j, tile, ref baseOption);
					}
				}
			}
			if (num3 == 0)
		...
		private static void InternalSaveMap()
		{
			...
			{
				string text2 = text;
				Guid uniqueId = Main.ActiveWorldFileData.UniqueId;
				text = text2 + uniqueId.ToString() + ".map";
			}
			else
			{
