...
namespace Terraria
{
	public static class Wiring
	{
		...
		public static IProjectileSource GetProjectileSource(int sourceTileX, int sourceTileY)
		{
			return new ProjectileSource_Wiring(sourceTileX, sourceTileY);
		}
		...
		private static void HitWireSingle(int i, int j)
		{
			...
			if (type == 209)
			{
				int num27 = tile.frameX % 72 / 18;
				int num28 = tile.frameY % 54 / 18;
				int num29 = i - num27;
				int num30 = j - num28;
				int num31 = tile.frameY / 54;
				int num32 = tile.frameX / 72;
				int num33 = -1;
				if (num27 == 1 || num27 == 2)
				{
					num33 = num28;
				...
				if (num34 != 0)
				{
					for (int num35 = num29; num35 < num29 + 4; num35++)
					{
						for (int num36 = num30; num36 < num30 + 3; num36++)
						{
							...
							Main.tile[num35, num36].frameY = (short)(Main.tile[num35, num36].frameY + num34);
						}
					}
					flag = true;
				}
				if ((num32 == 3 || num32 == 4) && (num33 == 0 || num33 == 1))
				{
					...
					for (int num37 = num29; num37 < num29 + 4; num37++)
					{
						for (int num38 = num30; num38 < num30 + 3; num38++)
						{
							...
							Main.tile[num37, num38].frameX = (short)(Main.tile[num37, num38].frameX + num34);
						}
					}
					flag = true;
				}
			...
			if (type == 212)
			{
				int num39 = tile.frameX % 54 / 18;
				int num40 = tile.frameY % 54 / 18;
				int num41 = i - num39;
				int num42 = j - num40;
				int num43 = tile.frameX / 54;
				int num44 = -1;
				if (num39 == 1)
				{
					num44 = num40;
				...
				if (num45 != 0)
				{
					for (int num46 = num41; num46 < num41 + 3; num46++)
					{
						for (int num47 = num42; num47 < num42 + 3; num47++)
						{
							...
							Main.tile[num46, num47].frameX = (short)(Main.tile[num46, num47].frameX + num45);
						}
					}
					flag3 = true;
				}
			...
			case 338:
			{
				int num63 = j - tile.frameY / 18;
				int num64 = i - tile.frameX / 18;
			...
			case 429:
			{
				int num66 = Main.tile[i, j].frameX / 18;
			...
			{
				int num119;
				for (num119 = tile.frameX / 18; num119 >= 3; num119 -= 3)
				{
				}
				int num120;
				for (num120 = tile.frameY / 18; num120 >= 3; num120 -= 3)
				{
				}
				int num121 = i - num119;
				int num122 = j - num120;
				int num123 = 54;
				if (Main.tile[num121, num122].frameX >= 54)
				{
					num123 = -54;
				}
				for (int num124 = num121; num124 < num121 + 3; num124++)
				{
					for (int num125 = num122; num125 < num122 + 2; num125++)
					{
						...
						Main.tile[num124, num125].frameX = (short)(Main.tile[num124, num125].frameX + num123);
					}
				}
			...
			{
				int num86;
				for (num86 = tile.frameX / 18; num86 >= 2; num86 -= 2)
				{
				}
				int num87;
				for (num87 = tile.frameY / 18; num87 >= 2; num87 -= 2)
				{
				}
				int num88 = i - num86;
				int num89 = j - num87;
				...
				for (int num91 = num88; num91 < num88 + 2; num91++)
				{
					for (int num92 = num89; num92 < num89 + 2; num92++)
					{
						...
						Main.tile[num91, num92].frameX = (short)(Main.tile[num91, num92].frameX + num90);
					}
				}
			...
			{
				int num68;
				for (num68 = tile.frameY / 18; num68 >= 2; num68 -= 2)
				{
				}
				num68 = j - num68;
				int num69 = tile.frameX / 18;
				if (num69 > 1)
				{
					num69 -= 2;
				}
				...
				short num70 = (short)((Main.tile[num69, num68].frameX != 0) ? (-36) : 36);
				for (int num71 = 0; num71 < 2; num71++)
				{
					for (int num72 = 0; num72 < 2; num72++)
					{
						Main.tile[num69 + num71, num68 + num72].frameX += num70;
					}
				}
				if (Main.netMode == 2)
				{
			...
			case 137:
			{
				...
				case 2:
					...
					{
						int num135 = ((tile.frameX == 0) ? (-1) : ((tile.frameX == 18) ? 1 : 0));
						int num136 = ((tile.frameX >= 36) ? ((tile.frameX >= 72) ? 1 : (-1)) : 0);
			...
			case 531:
			{
				int num114 = tile.frameX / 36;
				int num115 = tile.frameY / 54;
				int num116 = i - (tile.frameX - num114 * 36) / 18;
				int num117 = j - (tile.frameY - num115 * 54) / 18;
			...
			case 105:
			{
				...
				num97 = i - num97;
				num97 = i - tile.frameX % 36 / 18;
				num96 = j - tile.frameY % 54 / 18;
				int num99 = tile.frameY / 54;
				num99 %= 3;
				num98 = tile.frameX / 36 + num99 * 55;
				...
				case 35:
					...
					break;
				case 51:
					num103 = Utils.SelectRandom(Main.rand, new short[2] { 299, 538 });
					break;
				case 52:
					num103 = 356;
					break;
				case 53:
					...
					break;
				case 54:
					num103 = Utils.SelectRandom(Main.rand, new short[2] { 355, 358 });
					break;
				case 55:
					num103 = Utils.SelectRandom(Main.rand, new short[2] { 367, 366 });
					break;
				case 56:
					num103 = Utils.SelectRandom(Main.rand, new short[5] { 359, 359, 359, 359, 360 });
					break;
				case 57:
					num103 = 377;
					break;
				case 58:
					...
					break;
				case 59:
					num103 = Utils.SelectRandom(Main.rand, new short[2] { 364, 362 });
					break;
				case 60:
					num103 = 148;
					break;
				case 61:
					...
					break;
				case 62:
					num103 = Utils.SelectRandom(Main.rand, new short[3] { 487, 486, 485 });
					break;
				case 63:
					num103 = 164;
				...
				case 70:
					...
					break;
				case 71:
					num103 = Utils.SelectRandom(Main.rand, new short[3] { 170, 180, 171 });
					flag12 = true;
					break;
				case 72:
					num103 = 481;
				...
				case 77:
					...
					break;
				case 78:
					num103 = Utils.SelectRandom(Main.rand, new short[6] { 595, 596, 599, 597, 600, 598 });
					break;
				case 79:
					num103 = Utils.SelectRandom(Main.rand, new short[2] { 616, 617 });
					break;
				}
				if (num103 != -1 && CheckMech(num97, num96, 30) && NPC.MechSpawn(num100, num101, num103) && flag11)
				{
					...
					{
						num102 = NPC.NewNPC(num100, num101, num103);
					}
					else
					{
				...
				if (num102 <= -1)
				{
					...
					case 9:
					{
						...
						{
							num102 = NPC.NewNPC(num100, num101 - 12, type4);
						}
						break;
					}
					case 10:
						...
						{
							num102 = NPC.NewNPC(num100, num101, 21);
						}
						break;
					case 16:
						if (CheckMech(num97, num96, 30) && NPC.MechSpawn(num100, num101, 42))
						{
							...
							{
								num102 = NPC.NewNPC(num100, num101 - 12, 42);
								break;
							}
					...
					case 18:
						...
						{
							num102 = NPC.NewNPC(num100, num101 - 12, 67);
						}
						break;
					case 23:
						if (CheckMech(num97, num96, 30) && NPC.MechSpawn(num100, num101, 63))
						{
							num102 = NPC.NewNPC(num100, num101 - 12, 63);
						}
						break;
					case 27:
						if (CheckMech(num97, num96, 30) && NPC.MechSpawn(num100, num101, 85))
						{
							num102 = NPC.NewNPC(num100 - 9, num101, 85);
						}
						break;
					case 28:
						if (CheckMech(num97, num96, 30) && NPC.MechSpawn(num100, num101, 74))
						{
							num102 = NPC.NewNPC(num100, num101 - 12, Utils.SelectRandom(Main.rand, new short[3] { 74, 297, 298 }));
						}
						break;
					case 34:
					{
						for (int num112 = 0; num112 < 2; num112++)
						{
							for (int num113 = 0; num113 < 3; num113++)
							{
								...
								tile2.type = 349;
								tile2.frameX = (short)(num112 * 18 + 216);
								tile2.frameY = (short)(num113 * 18);
							}
						}
					...
					case 42:
						...
						{
							num102 = NPC.NewNPC(num100, num101 - 12, 58);
						}
						break;
					case 37:
						...
						{
							Item.NewItem(num100, num101 - 16, 0, 0, 58);
						}
						break;
					case 50:
						if (CheckMech(num97, num96, 30) && NPC.MechSpawn(num100, num101, 65))
						{
							...
							{
								num102 = NPC.NewNPC(num100, num101 - 12, 65);
								break;
							}
					...
					case 2:
						...
						{
							Item.NewItem(num100, num101 - 16, 0, 0, 184);
						}
						break;
					case 17:
						if (CheckMech(num97, num96, 600) && Item.MechSpawn(num100, num101, 166))
						{
							Item.NewItem(num100, num101 - 20, 0, 0, 166);
						}
						break;
					case 40:
					{
			...
			case 349:
			{
				int num74 = tile.frameY / 18;
				num74 %= 3;
				int num75 = j - num74;
				int num76;
				for (num76 = tile.frameX / 18; num76 >= 2; num76 -= 2)
				{
				}
				num76 = i - num76;
				...
				short num77 = (short)((Main.tile[num76, num75].frameX != 0) ? (-216) : 216);
				for (int num78 = 0; num78 < 2; num78++)
				{
					for (int num79 = 0; num79 < 3; num79++)
					{
						Main.tile[num76 + num78, num75 + num79].frameX += num77;
					}
				}
				if (Main.netMode == 2)
				{
			...
			case 506:
			{
				int num57 = tile.frameY / 18;
				num57 %= 3;
				int num58 = j - num57;
				int num59;
				for (num59 = tile.frameX / 18; num59 >= 2; num59 -= 2)
				{
				}
				num59 = i - num59;
				...
				short num60 = (short)((Main.tile[num59, num58].frameX >= 72) ? (-72) : 72);
				for (int num61 = 0; num61 < 2; num61++)
				{
					for (int num62 = 0; num62 < 3; num62++)
					{
						Main.tile[num59 + num61, num58 + num62].frameX += num60;
					}
				}
				if (Main.netMode == 2)
				{
