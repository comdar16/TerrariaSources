	...
	public static class IngameOptions
	{
		...
		public static void Draw(Main mainInstance, SpriteBatch sb)
		{
			...
			if (category == 2)
			{
				...
				num19++;
				vector6.X += num;
				if (DrawRightSide(sb, Lang.menu[247 + Main.FrameSkipMode].Value, num19, vector6, vector7, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
				{
					rightHover = num19;
					if (flag4)
					{
				...
				{
				case 1:
					textValue5 = Language.GetTextValue("GameUI.QualityLow");
					break;
				case 2:
					textValue5 = Language.GetTextValue("GameUI.QualityMedium");
					break;
				case 3:
					textValue5 = Language.GetTextValue("GameUI.QualityHigh");
					break;
				default:
					textValue5 = Language.GetTextValue("GameUI.QualityOff");
					break;
				}
				if (DrawRightSide(sb, Language.GetTextValue("GameUI.WaveQuality", textValue5), num19, vector6, vector7, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
				{
					rightHover = num19;
					if (flag4)
					{
