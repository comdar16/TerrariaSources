...
namespace Terraria.GameInput
{
	public class PlayerInput
	{
		...
		public static List<string> KnownTriggers = new List<string>
		{
			...
			"ViewZoomOut", "ToggleCreativeMenu"
		};
		...
		private static bool InvalidateKeyboardSwap()
		{
			...
			{
				text = text + pressedKeys[i].ToString() + ", ";
			}
		...
		public static void Reset(KeyConfiguration c, PresetProfiles style, InputMode mode)
		{
			...
			case PresetProfiles.Redigit:
				...
				case InputMode.KeyboardUI:
					...
					c.KeyStatus["MenuDown"].Add(Buttons.DPadDown.ToString() ?? "");
					c.KeyStatus["MenuLeft"].Add(Buttons.DPadLeft.ToString() ?? "");
					c.KeyStatus["MenuRight"].Add(Buttons.DPadRight.ToString() ?? "");
					break;
				case InputMode.XBoxGamepad:
					c.KeyStatus["MouseLeft"].Add(Buttons.RightTrigger.ToString() ?? "");
					c.KeyStatus["MouseRight"].Add(Buttons.B.ToString() ?? "");
					c.KeyStatus["Up"].Add(Buttons.LeftThumbstickUp.ToString() ?? "");
					c.KeyStatus["Down"].Add(Buttons.LeftThumbstickDown.ToString() ?? "");
					c.KeyStatus["Left"].Add(Buttons.LeftThumbstickLeft.ToString() ?? "");
					c.KeyStatus["Right"].Add(Buttons.LeftThumbstickRight.ToString() ?? "");
					c.KeyStatus["Jump"].Add(Buttons.LeftTrigger.ToString() ?? "");
					c.KeyStatus["Inventory"].Add(Buttons.Y.ToString() ?? "");
					c.KeyStatus["Grapple"].Add(Buttons.B.ToString() ?? "");
					c.KeyStatus["LockOn"].Add(Buttons.X.ToString() ?? "");
					c.KeyStatus["QuickMount"].Add(Buttons.A.ToString() ?? "");
					c.KeyStatus["SmartSelect"].Add(Buttons.RightStick.ToString() ?? "");
					c.KeyStatus["SmartCursor"].Add(Buttons.LeftStick.ToString() ?? "");
					c.KeyStatus["HotbarMinus"].Add(Buttons.LeftShoulder.ToString() ?? "");
					c.KeyStatus["HotbarPlus"].Add(Buttons.RightShoulder.ToString() ?? "");
					c.KeyStatus["MapFull"].Add(Buttons.Start.ToString() ?? "");
					c.KeyStatus["DpadSnap1"].Add(Buttons.DPadUp.ToString() ?? "");
					c.KeyStatus["DpadSnap3"].Add(Buttons.DPadDown.ToString() ?? "");
					c.KeyStatus["DpadSnap4"].Add(Buttons.DPadLeft.ToString() ?? "");
					c.KeyStatus["DpadSnap2"].Add(Buttons.DPadRight.ToString() ?? "");
					c.KeyStatus["MapStyle"].Add(Buttons.Back.ToString() ?? "");
					break;
				case InputMode.XBoxGamepadUI:
					c.KeyStatus["MouseLeft"].Add(Buttons.A.ToString() ?? "");
					c.KeyStatus["MouseRight"].Add(Buttons.LeftShoulder.ToString() ?? "");
					c.KeyStatus["SmartCursor"].Add(Buttons.RightShoulder.ToString() ?? "");
					c.KeyStatus["Up"].Add(Buttons.LeftThumbstickUp.ToString() ?? "");
					c.KeyStatus["Down"].Add(Buttons.LeftThumbstickDown.ToString() ?? "");
					c.KeyStatus["Left"].Add(Buttons.LeftThumbstickLeft.ToString() ?? "");
					c.KeyStatus["Right"].Add(Buttons.LeftThumbstickRight.ToString() ?? "");
					c.KeyStatus["Inventory"].Add(Buttons.B.ToString() ?? "");
					c.KeyStatus["Inventory"].Add(Buttons.Y.ToString() ?? "");
					c.KeyStatus["HotbarMinus"].Add(Buttons.LeftTrigger.ToString() ?? "");
					c.KeyStatus["HotbarPlus"].Add(Buttons.RightTrigger.ToString() ?? "");
					c.KeyStatus["Grapple"].Add(Buttons.X.ToString() ?? "");
					c.KeyStatus["MapFull"].Add(Buttons.Start.ToString() ?? "");
					c.KeyStatus["SmartSelect"].Add(Buttons.Back.ToString() ?? "");
					c.KeyStatus["QuickMount"].Add(Buttons.RightStick.ToString() ?? "");
					c.KeyStatus["DpadSnap1"].Add(Buttons.DPadUp.ToString() ?? "");
					c.KeyStatus["DpadSnap3"].Add(Buttons.DPadDown.ToString() ?? "");
					c.KeyStatus["DpadSnap4"].Add(Buttons.DPadLeft.ToString() ?? "");
					c.KeyStatus["DpadSnap2"].Add(Buttons.DPadRight.ToString() ?? "");
			...
			case PresetProfiles.Yoraiz0r:
				...
				case InputMode.XBoxGamepad:
					...
					c.KeyStatus["Jump"].Add(Buttons.LeftTrigger.ToString() ?? "");
					c.KeyStatus["Inventory"].Add(Buttons.Y.ToString() ?? "");
					c.KeyStatus["Grapple"].Add(Buttons.LeftShoulder.ToString() ?? "");
					c.KeyStatus["SmartSelect"].Add(Buttons.LeftStick.ToString() ?? "");
					c.KeyStatus["SmartCursor"].Add(Buttons.RightStick.ToString() ?? "");
					c.KeyStatus["QuickMount"].Add(Buttons.X.ToString() ?? "");
					c.KeyStatus["QuickHeal"].Add(Buttons.A.ToString() ?? "");
					c.KeyStatus["RadialHotbar"].Add(Buttons.RightShoulder.ToString() ?? "");
					c.KeyStatus["MapFull"].Add(Buttons.Start.ToString() ?? "");
					c.KeyStatus["DpadSnap1"].Add(Buttons.DPadUp.ToString() ?? "");
					c.KeyStatus["DpadSnap3"].Add(Buttons.DPadDown.ToString() ?? "");
					c.KeyStatus["DpadSnap4"].Add(Buttons.DPadLeft.ToString() ?? "");
				...
				case InputMode.XBoxGamepadUI:
					...
					c.KeyStatus["Left"].Add(Buttons.LeftThumbstickLeft.ToString() ?? "");
					c.KeyStatus["Right"].Add(Buttons.LeftThumbstickRight.ToString() ?? "");
					c.KeyStatus["LockOn"].Add(Buttons.B.ToString() ?? "");
					c.KeyStatus["Inventory"].Add(Buttons.Y.ToString() ?? "");
					c.KeyStatus["HotbarMinus"].Add(Buttons.LeftTrigger.ToString() ?? "");
					c.KeyStatus["HotbarPlus"].Add(Buttons.RightTrigger.ToString() ?? "");
					c.KeyStatus["Grapple"].Add(Buttons.X.ToString() ?? "");
			...
			case PresetProfiles.ConsolePS:
				...
				case InputMode.KeyboardUI:
					...
					break;
				case InputMode.XBoxGamepad:
					c.KeyStatus["MouseLeft"].Add(Buttons.RightShoulder.ToString() ?? "");
					c.KeyStatus["MouseRight"].Add(Buttons.B.ToString() ?? "");
					c.KeyStatus["Up"].Add(Buttons.LeftThumbstickUp.ToString() ?? "");
					c.KeyStatus["Down"].Add(Buttons.LeftThumbstickDown.ToString() ?? "");
					c.KeyStatus["Left"].Add(Buttons.LeftThumbstickLeft.ToString() ?? "");
					c.KeyStatus["Right"].Add(Buttons.LeftThumbstickRight.ToString() ?? "");
					c.KeyStatus["Jump"].Add(Buttons.A.ToString() ?? "");
					c.KeyStatus["LockOn"].Add(Buttons.X.ToString() ?? "");
					c.KeyStatus["Inventory"].Add(Buttons.Y.ToString() ?? "");
					c.KeyStatus["Grapple"].Add(Buttons.LeftShoulder.ToString() ?? "");
					c.KeyStatus["SmartSelect"].Add(Buttons.LeftStick.ToString() ?? "");
					...
					c.KeyStatus["HotbarPlus"].Add(Buttons.RightTrigger.ToString() ?? "");
					c.KeyStatus["MapFull"].Add(Buttons.Start.ToString() ?? "");
					c.KeyStatus["DpadRadial1"].Add(Buttons.DPadUp.ToString() ?? "");
					c.KeyStatus["DpadRadial3"].Add(Buttons.DPadDown.ToString() ?? "");
					c.KeyStatus["DpadRadial4"].Add(Buttons.DPadLeft.ToString() ?? "");
					c.KeyStatus["DpadRadial2"].Add(Buttons.DPadRight.ToString() ?? "");
					c.KeyStatus["QuickMount"].Add(Buttons.Back.ToString() ?? "");
					break;
				case InputMode.XBoxGamepadUI:
					c.KeyStatus["MouseLeft"].Add(Buttons.A.ToString() ?? "");
					c.KeyStatus["MouseRight"].Add(Buttons.LeftShoulder.ToString() ?? "");
			...
			case PresetProfiles.ConsoleXBox:
				...
				case InputMode.XBoxGamepad:
					...
					c.KeyStatus["LockOn"].Add(Buttons.X.ToString() ?? "");
					c.KeyStatus["Inventory"].Add(Buttons.Y.ToString() ?? "");
					c.KeyStatus["Grapple"].Add(Buttons.LeftTrigger.ToString() ?? "");
					c.KeyStatus["SmartSelect"].Add(Buttons.LeftStick.ToString() ?? "");
					c.KeyStatus["SmartCursor"].Add(Buttons.RightStick.ToString() ?? "");
					c.KeyStatus["HotbarMinus"].Add(Buttons.LeftShoulder.ToString() ?? "");
					c.KeyStatus["HotbarPlus"].Add(Buttons.RightShoulder.ToString() ?? "");
