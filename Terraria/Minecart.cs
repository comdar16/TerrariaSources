...
namespace Terraria
{
	public static class Minecart
	{
		...
		public static BitsByte TrackCollision(ref Vector2 Position, ref Vector2 Velocity, ref Vector2 lastBoost, int Width, int Height, bool followDown, bool followUp, int fallStart, bool trackOnly, Mount.MountDelegatesData delegatesData)
		{
		...
		public static float TrackRotation(ref float rotation, Vector2 Position, int Width, int Height, bool followDown, bool followUp, Mount.MountDelegatesData delegatesData)
		{
			GetWheelsPositions(Position, Width, Height, followDown, followUp, delegatesData, out var leftWheel, out var rightWheel);
		...
		public static void GetWheelsPositions(Vector2 Position, int Width, int Height, bool followDown, bool followUp, Mount.MountDelegatesData delegatesData, out Vector2 leftWheel, out Vector2 rightWheel)
		{
			leftWheel = Position;
			rightWheel = Position;
