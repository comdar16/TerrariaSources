...
namespace Terraria
{
	public class Item : Entity
	{
		...
		public bool FitsAccessoryVanitySlot
		{
			get
			{
				if (!canBePlacedInVanityRegardlessOfConditions && handOnSlot == -1 && handOffSlot == -1 && backSlot == -1 && frontSlot == -1 && shoeSlot == -1 && waistSlot == -1 && wingSlot == -1 && shieldSlot == -1 && neckSlot == -1 && faceSlot == -1 && balloonSlot == -1)
				{
					return beardSlot != -1;
				}
				return true;
