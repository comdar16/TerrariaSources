...
namespace Terraria.DataStructures
{
	public static class PlayerDrawHeadLayers
	{
		...
		public static void DrawPlayer_04_RabbitOrder(ref PlayerDrawHeadSet drawinfo)
		{
			...
			int num = DrawPlayer_04_GetHatStacks(ref drawinfo, 4955);
			...
			for (int num4 = num - 1; num4 >= 0; num4--)
			{
				...
				QuickCDD(drawinfo.DrawData, drawinfo.cHead, value, vector + new Vector2(x, (float)(num4 * -14) * drawinfo.scale), rectangle, drawinfo.colorArmorHead, drawinfo.drawPlayer.headRotation, origin, drawinfo.scale, drawinfo.playerEffect, 0f);
			}
			if (!drawinfo.hideHair)
			{
				Rectangle hairFrame = drawinfo.HairFrame;
		...
		public static void DrawPlayer_04_BadgersHat(ref PlayerDrawHeadSet drawinfo)
		{
			...
			int num2 = DrawPlayer_04_GetHatStacks(ref drawinfo, 5004);
			...
			for (int num7 = num5 - 1; num7 >= 0; num7--)
			{
				...
				if (!(rectangle.Y == rectangle.Height * 3 && flag))
				{
					...
					QuickCDD(drawinfo.DrawData, drawinfo.cHead, value, vector + new Vector2(x, (num7 * -4 + num8) * num) * drawinfo.scale, rectangle, drawinfo.colorArmorHead, drawinfo.drawPlayer.headRotation, origin, drawinfo.scale, drawinfo.playerEffect, 0f);
				}
			}
		}
		...
		public static void DrawPlayer_06_NormalHats(ref PlayerDrawHeadSet drawinfo)
		{
			...
			else
			{
				...
				Rectangle value2 = value.Frame(6, 4, num, frameY);
