	...
	public static class PlayerDrawLayers
	{
		...
		public static void DrawCompositeArmorPiece(ref PlayerDrawSet drawinfo, CompositePlayerDrawContext context, DrawData data)
		{
			...
			if (context == CompositePlayerDrawContext.FrontShoulder && drawinfo.drawPlayer.head == 269)
			{
				...
				DrawData item3 = new DrawData(TextureAssets.Extra[214].Value, position3, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorHead, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
				item3.shader = drawinfo.cHead;
				drawinfo.DrawDataCache.Add(item3);
				item3 = new DrawData(TextureAssets.GlowMask[308].Value, position3, drawinfo.drawPlayer.bodyFrame, drawinfo.headGlowColor, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
				item3.shader = drawinfo.cHead;
				drawinfo.DrawDataCache.Add(item3);
			}
		...
		public static void DrawPlayer_01_BackHair(ref PlayerDrawSet drawinfo)
		{
			if (!drawinfo.hideHair && drawinfo.backHairDraw)
			{
				...
				{
					item = new DrawData(TextureAssets.PlayerHair[drawinfo.drawPlayer.hair].Value, position, drawinfo.hairBackFrame, drawinfo.colorHair, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
					item.shader = drawinfo.hairDyePacked;
					drawinfo.DrawDataCache.Add(item);
				}
				else if (drawinfo.hatHair)
				{
					item = new DrawData(TextureAssets.PlayerHairAlt[drawinfo.drawPlayer.hair].Value, position, drawinfo.hairBackFrame, drawinfo.colorHair, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
					item.shader = drawinfo.hairDyePacked;
					drawinfo.DrawDataCache.Add(item);
				}
			}
		...
		public static void DrawPlayer_08_Backpacks(ref PlayerDrawSet drawinfo)
		{
			...
			if (DrawPlayer_08_PlayerVisuallyHasFullArmorSet(drawinfo, 266, 235, 218))
			{
				...
				item = new DrawData(value, vec, value2, immuneAlphaPure, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0);
				item.shader = drawinfo.cBody;
				drawinfo.DrawDataCache.Add(item);
			}
			if (DrawPlayer_08_PlayerVisuallyHasFullArmorSet(drawinfo, 268, 237, 222))
			{
				...
				item = new DrawData(value3, vec2, value4, immuneAlphaPure2, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0);
				item.shader = drawinfo.cBody;
				drawinfo.DrawDataCache.Add(item);
			}
			if (drawinfo.heldItem.type == 4818 && drawinfo.drawPlayer.ownedProjectileCounts[902] == 0)
			{
				...
				vec3 = vec3.Floor();
				item = new DrawData(TextureAssets.BackPack[num].Value, vec3, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0);
				drawinfo.DrawDataCache.Add(item);
			}
			if (drawinfo.drawPlayer.backpack > 0 && drawinfo.drawPlayer.backpack < 35 && !drawinfo.drawPlayer.mount.Active)
			{
				...
				vec4 = vec4.Floor();
				item = new DrawData(TextureAssets.AccBack[drawinfo.drawPlayer.backpack].Value, vec4, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0);
			...
			else
			{
				...
				{
				case 7:
					item = new DrawData(TextureAssets.BackPack[num2].Value, vec5, new Rectangle(0, drawinfo.drawPlayer.bodyFrame.Y, TextureAssets.BackPack[num2].Width(), drawinfo.drawPlayer.bodyFrame.Height), drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, new Vector2((float)TextureAssets.BackPack[num2].Width() * 0.5f, drawinfo.bodyVect.Y), 1f, drawinfo.playerEffect, 0);
					item.shader = shader;
					drawinfo.DrawDataCache.Add(item);
					break;
				case 4:
				case 6:
					item = new DrawData(TextureAssets.BackPack[num2].Value, vec5, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0);
					item.shader = shader;
					drawinfo.DrawDataCache.Add(item);
					break;
				default:
					item = new DrawData(TextureAssets.BackPack[num2].Value, vec6, new Rectangle(0, 0, TextureAssets.BackPack[num2].Width(), TextureAssets.BackPack[num2].Height()), drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.BackPack[num2].Width() / 2, TextureAssets.BackPack[num2].Height() / 2), 1f, drawinfo.playerEffect, 0);
					item.shader = shader;
					drawinfo.DrawDataCache.Add(item);
					break;
				}
		...
		{
			if (drawinfo.drawPlayer.tail > 0 && drawinfo.drawPlayer.tail < 35 && !drawinfo.drawPlayer.mount.Active)
			{
				...
				vec = vec.Floor();
				DrawData item = new DrawData(TextureAssets.AccBack[drawinfo.drawPlayer.tail].Value, vec, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0);
		...
		public static void DrawPlayer_09_Wings(ref PlayerDrawSet drawinfo)
		{
			...
			if (drawinfo.drawPlayer.wings == 28)
			{
				if (drawinfo.drawPlayer.ShouldDrawWingsThatAreAlwaysAnimated())
				{
					...
					rectangle.Width -= 2;
					rectangle.Height -= 2;
					item = new DrawData(value, vec.Floor(), rectangle, Color.Lerp(colorArmorBody2, Color.White, 1f), drawinfo.drawPlayer.bodyRotation, rectangle.Size() / 2f, 1f, drawinfo.playerEffect, 0);
					item.shader = drawinfo.cWings;
					drawinfo.DrawDataCache.Add(item);
					value = TextureAssets.Extra[38].Value;
					item = new DrawData(value, vec.Floor(), rectangle, Color.Lerp(colorArmorBody2, Color.White, 0.5f), drawinfo.drawPlayer.bodyRotation, rectangle.Size() / 2f, 1f, drawinfo.playerEffect, 0);
					item.shader = drawinfo.cWings;
					drawinfo.DrawDataCache.Add(item);
				}
				return;
			...
			if (drawinfo.drawPlayer.wings == 34)
			{
				if (drawinfo.drawPlayer.ShouldDrawWingsThatAreAlwaysAnimated())
				{
					...
					rectangle2.Width -= 2;
					rectangle2.Height -= 2;
					item = new DrawData(value2, vec3.Floor(), rectangle2, color5, drawinfo.drawPlayer.bodyRotation, rectangle2.Size() / 2f, 1f, drawinfo.playerEffect, 0);
					item.shader = drawinfo.cWings;
					drawinfo.DrawDataCache.Add(item);
				}
				return;
			...
			if (drawinfo.drawPlayer.wings == 40)
			{
				...
				for (int j = 0; j < 1; j++)
				{
					...
					for (int k = num7; k < num8; k++)
					{
						...
						vec4 += zero;
						item = new DrawData(value3, vec4.Floor(), rectangle3, color6, drawinfo.drawPlayer.bodyRotation, rectangle3.Size() / 2f, scale, spriteEffects, 0);
						item.shader = drawinfo.cWings;
						drawinfo.DrawDataCache.Add(item);
					}
				}
			...
			if (drawinfo.drawPlayer.wings == 39)
			{
				if (drawinfo.drawPlayer.ShouldDrawWingsThatAreAlwaysAnimated())
				{
					...
					rectangle4.Width -= 2;
					rectangle4.Height -= 2;
					item = new DrawData(value4, vec5.Floor(), rectangle4, colorArmorBody3, drawinfo.drawPlayer.bodyRotation, rectangle4.Size() / 2f, 1f, drawinfo.playerEffect, 0);
					item.shader = drawinfo.cWings;
					drawinfo.DrawDataCache.Add(item);
				}
				return;
			...
			if (drawinfo.drawPlayer.wings == 43 && drawinfo.shadow == 0f)
			{
				...
				for (int l = 0; l < 2; l++)
				{
					item = new DrawData(position: vector13 + new Vector2((float)Main.rand.Next(-10, 10) * 0.125f, (float)Main.rand.Next(-10, 10) * 0.125f), texture: TextureAssets.GlowMask[272].Value, sourceRect: value5, color: new Color(230, 230, 230, 60), rotation: drawinfo.drawPlayer.bodyRotation, origin: origin, scale: 1f, effect: drawinfo.playerEffect, inactiveLayerDepth: 0);
					item.shader = drawinfo.cWings;
					drawinfo.DrawDataCache.Add(item);
				}
			}
		...
		public static void DrawPlayer_12_SkinComposite_BackArmShirt(ref PlayerDrawSet drawinfo)
		{
			...
			if (flag3)
			{
				...
				if (flag2 && drawinfo.missingArm)
				{
					...
					{
						List<DrawData> drawDataCache = drawinfo.DrawDataCache;
						drawData = new DrawData(TextureAssets.Players[drawinfo.skinVar, 7].Value, vector3, drawinfo.compBackArmFrame, drawinfo.colorBodySkin, rotation, bodyVect, 1f, drawinfo.playerEffect, 0)
						{
							shader = drawinfo.skinDyePacked
						};
						drawDataCache.Add(drawData);
					...
					{
						List<DrawData> drawDataCache2 = drawinfo.DrawDataCache;
						drawData = new DrawData(TextureAssets.Players[drawinfo.skinVar, 5].Value, vector3, drawinfo.compBackArmFrame, drawinfo.colorBodySkin, rotation, bodyVect, 1f, drawinfo.playerEffect, 0)
						{
							shader = drawinfo.skinDyePacked
						};
						drawDataCache2.Add(drawData);
				...
				if (!drawinfo.drawPlayer.invis || IsArmorDrawnWhenInvisible(drawinfo.drawPlayer.body))
				{
					...
					{
						drawData = new DrawData(value, position, drawinfo.compBackShoulderFrame, drawinfo.colorArmorBody, bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0)
						{
							shader = drawinfo.cBody
						};
						DrawCompositeArmorPiece(ref drawinfo, CompositePlayerDrawContext.BackShoulder, drawData);
					}
					DrawPlayer_12_1_BalloonFronts(ref drawinfo);
					drawData = new DrawData(value, vector3, drawinfo.compBackArmFrame, drawinfo.colorArmorBody, rotation, bodyVect, 1f, drawinfo.playerEffect, 0)
					{
						shader = drawinfo.cBody
					};
					DrawCompositeArmorPiece(ref drawinfo, CompositePlayerDrawContext.BackArm, drawData);
				}
			}
			if (flag)
			{
				...
				if (!flag3)
				{
					drawinfo.DrawDataCache.Add(new DrawData(TextureAssets.Players[drawinfo.skinVar, 8].Value, vector3, drawinfo.compBackArmFrame, drawinfo.colorUnderShirt, rotation, bodyVect, 1f, drawinfo.playerEffect, 0));
					DrawPlayer_12_1_BalloonFronts(ref drawinfo);
					drawinfo.DrawDataCache.Add(new DrawData(TextureAssets.Players[drawinfo.skinVar, 13].Value, vector3, drawinfo.compBackArmFrame, drawinfo.colorShirt, rotation, bodyVect, 1f, drawinfo.playerEffect, 0));
				}
			}
			if (drawinfo.drawPlayer.handoff > 0 && drawinfo.drawPlayer.handoff < 15)
			{
				...
				drawData = new DrawData(value2, vector3, drawinfo.compBackArmFrame, drawinfo.colorArmorBody, rotation, bodyVect, 1f, drawinfo.playerEffect, 0)
				{
			...
			if (drawinfo.drawPlayer.drawingFootball)
			{
				...
				drawinfo.DrawDataCache.Add(new DrawData(value3, position2, rectangle, drawinfo.colorArmorBody, bodyRotation + (float)Math.PI / 4f * (float)drawinfo.drawPlayer.direction, origin, 0.8f, drawinfo.playerEffect, 0));
			}
		}
		...
		public static void DrawPlayer_13_Leggings(ref PlayerDrawSet drawinfo)
		{
			...
			else if (drawinfo.drawPlayer.legs == 140)
			{
				if (!drawinfo.drawPlayer.invis && !drawinfo.drawPlayer.mount.Active)
				{
					...
					Vector2 vector2 = vector + new Vector2(0f, (0f - num2) * drawinfo.drawPlayer.gravDir) - Main.screenPosition + drawinfo.drawPlayer.legPosition;
					if (drawinfo.isSitting)
					{
						vector2.Y += drawinfo.seatYOffset;
					}
					vector2 += legsOffset;
					vector2 = vector2.Floor();
					item = new DrawData(value, vector2, rectangle, drawinfo.colorArmorLegs, drawinfo.drawPlayer.legRotation, rectangle.Size() * new Vector2(0.5f, 0.5f - drawinfo.drawPlayer.gravDir * 0.5f), scale, drawinfo.playerEffect, 0);
					item.shader = drawinfo.cLegs;
					drawinfo.DrawDataCache.Add(item);
				}
			}
		...
		private static void DrawSittingLongCoats(ref PlayerDrawSet drawinfo, int specialLegCoat, Texture2D textureToDraw, Color matchingColor, int shaderIndex = 0, bool glowmask = false)
		{
			...
			DrawData item = new DrawData(textureToDraw, position, legFrame, matchingColor, drawinfo.drawPlayer.legRotation, drawinfo.legVect, 1f, drawinfo.playerEffect, 0);
		...
		private static void DrawSittingLegs(ref PlayerDrawSet drawinfo, Texture2D textureToDraw, Color matchingColor, int shaderIndex = 0, bool glowmask = false)
		{
			...
			for (int num8 = num3; num8 >= 0; num8--)
			{
				...
				position.Y += num2;
				position.Y += num5;
				DrawData item = new DrawData(textureToDraw, position, value, matchingColor, drawinfo.drawPlayer.legRotation, drawinfo.legVect, 1f, drawinfo.playerEffect, 0);
				item.shader = shaderIndex;
				drawinfo.DrawDataCache.Add(item);
			}
		}
		...
		public static void DrawPlayer_17_TorsoComposite(ref PlayerDrawSet drawinfo)
		{
			...
			if (drawinfo.drawPlayer.body > 0 && drawinfo.drawPlayer.body < 246)
			{
				...
				{
					Texture2D value = TextureAssets.ArmorBodyComposite[drawinfo.drawPlayer.body].Value;
					drawData = new DrawData(value, vector, drawinfo.compTorsoFrame, drawinfo.colorArmorBody, bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0)
					{
						shader = drawinfo.cBody
					};
		...
		public static void DrawPlayer_21_Head(ref PlayerDrawSet drawinfo)
		{
			...
			{
				item = new DrawData(TextureAssets.PlayerHairAlt[drawinfo.drawPlayer.hair].Value, position, drawinfo.hairFrontFrame, drawinfo.colorHair, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
				item.shader = drawinfo.hairDyePacked;
				drawinfo.DrawDataCache.Add(item);
			}
			...
			else if (drawinfo.drawPlayer.head == 259)
			{
				...
				int num3 = DrawPlayer_21_head_GetHatStacks(ref drawinfo, 4955);
				float num4 = (float)Math.PI / 60f;
				float num5 = num4 * drawinfo.drawPlayer.position.X % ((float)Math.PI * 2f);
				for (int num6 = num3 - 1; num6 >= 0; num6--)
				{
					float x = Vector2.UnitY.RotatedBy(num5 + num4 * (float)num6).X * ((float)num6 / 30f) * 2f - (float)(num6 * 2 * drawinfo.drawPlayer.direction);
					item = new DrawData(value, vector2 + new Vector2(x, (float)(num6 * -14) * drawinfo.drawPlayer.gravDir), rectangle, drawinfo.colorArmorHead, drawinfo.drawPlayer.headRotation, origin, 1f, drawinfo.playerEffect, 0);
					item.shader = drawinfo.cHead;
					drawinfo.DrawDataCache.Add(item);
				}
				if (!drawinfo.drawPlayer.invis)
			...
			else if (drawinfo.drawPlayer.head > 0 && drawinfo.drawPlayer.head < 277 && !flag2)
			{
				if (!(drawinfo.drawPlayer.invis && flag3))
				{
					if (drawinfo.drawPlayer.head == 13)
					{
						int num7 = 0;
						int num8 = 0;
						if (drawinfo.drawPlayer.armor[num8] != null && drawinfo.drawPlayer.armor[num8].type == 205 && drawinfo.drawPlayer.armor[num8].stack > 0)
						{
							num7 += drawinfo.drawPlayer.armor[num8].stack;
						}
						num8 = 10;
						if (drawinfo.drawPlayer.armor[num8] != null && drawinfo.drawPlayer.armor[num8].type == 205 && drawinfo.drawPlayer.armor[num8].stack > 0)
						{
					...
					else if (drawinfo.drawPlayer.head == 265)
					{
						...
						int num12 = DrawPlayer_21_head_GetHatStacks(ref drawinfo, 5004);
						...
						for (int num17 = num15 - 1; num17 >= 0; num17--)
						{
							...
							if (!(rectangle2.Y == rectangle2.Height * 3 && flag4))
							{
								...
								item = new DrawData(value2, vector3 + new Vector2(x2, (float)(num17 * -4 + num18) * drawinfo.drawPlayer.gravDir), rectangle2, drawinfo.colorArmorHead, drawinfo.drawPlayer.headRotation, origin2, 1f, drawinfo.playerEffect, 0);
								item.shader = drawinfo.cHead;
								drawinfo.DrawDataCache.Add(item);
							}
						}
						...
						if (drawinfo.headGlowMask != -1)
						{
							if (drawinfo.headGlowMask == 309)
							{
								...
								if (num19 != 0)
								{
									...
									Vector2 vector4 = Main.OffsetsPlayerHeadgear[num20];
									...
									Rectangle value4 = value3.Frame(6, 4, num19, frameY);
			...
			if (drawinfo.drawPlayer.head == 214 && !drawinfo.drawPlayer.invis)
			{
				...
				if (num22 >= num23)
				{
					color3 = Color.Lerp(Color.Transparent, new Color(200, 200, 200, 0), Utils.GetLerpValue(num23, num24, num22, clamped: true));
				}
				if (num22 >= num24)
				{
					color3 = Color.Lerp(Color.Transparent, new Color(200, 200, 200, 0), Utils.GetLerpValue(1f, num24, num22, clamped: true));
				}
				color3 *= drawinfo.stealth * (1f - drawinfo.shadow);
				item = new DrawData(TextureAssets.Extra[90].Value, helmetOffset + new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.headPosition + drawinfo.headVect - Main.OffsetsPlayerHeadgear[drawinfo.drawPlayer.bodyFrame.Y / drawinfo.drawPlayer.bodyFrame.Height], bodyFrame4, color3, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
				drawinfo.DrawDataCache.Add(item);
			}
		...
		private static Vector2 DrawPlayer_21_Head_GetSpecialHatDrawPosition(ref PlayerDrawSet drawinfo, ref Vector2 helmetOffset, Vector2 hatOffset)
		{
			...
			Vector2 vector2 = drawinfo.Position - Main.screenPosition + helmetOffset + new Vector2(-drawinfo.drawPlayer.bodyFrame.Width / 2 + drawinfo.drawPlayer.width / 2, drawinfo.drawPlayer.height - drawinfo.drawPlayer.bodyFrame.Height + 4) + hatOffset * drawinfo.drawPlayer.Directions + vector;
			vector2 = vector2.Floor();
		...
		{
			if (drawinfo.shadow == 0f && drawinfo.drawPlayer.neck == 11)
			{
				Color colorArmorBody = drawinfo.colorArmorBody;
		...
		public static void DrawPlayer_22_FaceAcc(ref PlayerDrawSet drawinfo)
		{
			...
			if (drawinfo.drawAngelHalo)
			{
				...
				item = new DrawData(TextureAssets.AccFace[7].Value, new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.headPosition + drawinfo.headVect, drawinfo.drawPlayer.bodyFrame, immuneAlphaPure, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
		...
		public static void DrawTiedBalloons(ref PlayerDrawSet drawinfo)
		{
			if (drawinfo.drawPlayer.mount.Type == 34)
			{
				...
				DrawData item = new DrawData(value, drawinfo.drawPlayer.MountedCenter + vector - Main.screenPosition, value2, colorMount, rotation, origin, 1f, drawinfo.playerEffect, 0);
				drawinfo.DrawDataCache.Add(item);
			}
		}
		...
		public static void DrawStarboardRainbowTrail(ref PlayerDrawSet drawinfo, Vector2 commonWingPosPreFloor, Vector2 dirsVec)
		{
			...
			for (int num5 = num; num5 > 0; num5--)
			{
				...
				{
					DrawData item = new DrawData(value, pos - Main.screenPosition, null, color, num6, origin, scale, drawinfo.playerEffect, 0);
					item.shader = drawinfo.cWings;
					drawinfo.DrawDataCache.Add(item);
					for (float num9 = 0.25f; num9 < 1f; num9 += 0.25f)
					{
						item = new DrawData(value, Vector2.Lerp(pos, pos2, num9) - Main.screenPosition, null, color, num6, origin, scale, drawinfo.playerEffect, 0);
						item.shader = drawinfo.cWings;
						drawinfo.DrawDataCache.Add(item);
					}
				}
		...
		public static void DrawMeowcartTrail(ref PlayerDrawSet drawinfo)
		{
			if (drawinfo.drawPlayer.mount.Type == 33)
			{
				...
				for (int num5 = num; num5 > 0; num5--)
				{
					...
					DrawData item = new DrawData(value, pos - Main.screenPosition, null, color, rotation, origin, scale, drawinfo.playerEffect, 0);
					drawinfo.DrawDataCache.Add(item);
				}
			}
		}
		...
		public static void DrawPlayer_27_HeldItem(ref PlayerDrawSet drawinfo)
		{
			...
			if (heldItem.useStyle == 9 && drawinfo.drawPlayer.itemAnimation > 0)
			{
				...
				origin = sourceRect.Value.Size() * vector2;
			}
			if (drawinfo.drawPlayer.gravDir == -1f)
			{
			...
			case 3476:
			{
				...
				item = new DrawData(value3, (drawinfo.ItemLocation - Main.screenPosition + vector4).Floor(), rectangle2, heldItem.GetAlpha(drawinfo.itemColor).MultiplyRGBA(new Color(new Vector4(0.5f, 0.5f, 0.5f, 0.8f))), drawinfo.drawPlayer.itemRotation, origin3, adjustedItemScale, drawinfo.itemEffect, 0);
				drawinfo.DrawDataCache.Add(item);
				value3 = TextureAssets.GlowMask[195].Value;
				item = new DrawData(value3, (drawinfo.ItemLocation - Main.screenPosition + vector4).Floor(), rectangle2, new Color(250, 250, 250, heldItem.alpha) * 0.5f, drawinfo.drawPlayer.itemRotation, origin3, adjustedItemScale, drawinfo.itemEffect, 0);
				drawinfo.DrawDataCache.Add(item);
				return;
			}
			case 4049:
			{
				...
				item = new DrawData(value2, (drawinfo.ItemLocation - Main.screenPosition + vector3).Floor(), rectangle, heldItem.GetAlpha(drawinfo.itemColor), drawinfo.drawPlayer.itemRotation, origin2, adjustedItemScale, drawinfo.itemEffect, 0);
				drawinfo.DrawDataCache.Add(item);
				return;
			}
			case 3779:
			{
				...
				{
					item = new DrawData(TextureAssets.GlowMask[218].Value, (drawinfo.ItemLocation - Main.screenPosition + vector5).Floor() + (num8 * ((float)Math.PI / 2f)).ToRotationVector2() * num7, rectangle3, color2, drawinfo.drawPlayer.itemRotation, origin4, adjustedItemScale, drawinfo.itemEffect, 0);
					drawinfo.DrawDataCache.Add(item);
				}
				item = new DrawData(texture2D, (drawinfo.ItemLocation - Main.screenPosition + vector5).Floor(), rectangle3, heldItem.GetAlpha(drawinfo.itemColor).MultiplyRGBA(new Color(new Vector4(0.5f, 0.5f, 0.5f, 0.8f))), drawinfo.drawPlayer.itemRotation, origin4, adjustedItemScale, drawinfo.itemEffect, 0);
				drawinfo.DrawDataCache.Add(item);
				return;
			}
			}
			if (heldItem.useStyle == 5)
			{
				...
				if (num == 5118)
				{
					...
					Vector2 vector8 = new Vector2((float)value.Width * 0.5f, (float)value.Height * 0.5f);
					...
					item = new DrawData(value, new Vector2((int)(drawinfo.ItemLocation.X - Main.screenPosition.X + vector8.X + spinningpoint.X), (int)(drawinfo.ItemLocation.Y - Main.screenPosition.Y + vector8.Y + spinningpoint.Y)), sourceRect, heldItem.GetAlpha(drawinfo.itemColor), rotation, origin6, adjustedItemScale, drawinfo.itemEffect, 0);
					drawinfo.DrawDataCache.Add(item);
					return;
				}
				int num12 = 10;
				Vector2 vector9 = new Vector2(value.Width / 2, value.Height / 2);
				...
				item = new DrawData(value, new Vector2((int)(drawinfo.ItemLocation.X - Main.screenPosition.X + vector9.X), (int)(drawinfo.ItemLocation.Y - Main.screenPosition.Y + vector9.Y)), sourceRect, heldItem.GetAlpha(drawinfo.itemColor), drawinfo.drawPlayer.itemRotation, origin7, adjustedItemScale, drawinfo.itemEffect, 0);
				drawinfo.DrawDataCache.Add(item);
				if (heldItem.color != default(Color))
				{
					item = new DrawData(value, new Vector2((int)(drawinfo.ItemLocation.X - Main.screenPosition.X + vector9.X), (int)(drawinfo.ItemLocation.Y - Main.screenPosition.Y + vector9.Y)), sourceRect, heldItem.GetColor(drawinfo.itemColor), drawinfo.drawPlayer.itemRotation, origin7, adjustedItemScale, drawinfo.itemEffect, 0);
					drawinfo.DrawDataCache.Add(item);
				}
				if (heldItem.glowMask != -1)
				{
					item = new DrawData(TextureAssets.GlowMask[heldItem.glowMask].Value, new Vector2((int)(drawinfo.ItemLocation.X - Main.screenPosition.X + vector9.X), (int)(drawinfo.ItemLocation.Y - Main.screenPosition.Y + vector9.Y)), sourceRect, new Color(250, 250, 250, heldItem.alpha), drawinfo.drawPlayer.itemRotation, origin7, adjustedItemScale, drawinfo.itemEffect, 0);
					drawinfo.DrawDataCache.Add(item);
				}
				if (num == 3788)
				{
			...
			if (num)
			{
				if (!drawinfo.drawPlayer.invis || IsArmorDrawnWhenInvisible(drawinfo.drawPlayer.body))
				{
					...
					for (int i = 0; i < 2; i++)
					{
						...
						{
							drawData = new DrawData(value, position, drawinfo.compFrontShoulderFrame, drawinfo.colorArmorBody, bodyRotation, bodyVect, 1f, drawinfo.playerEffect, 0)
							{
								shader = drawinfo.cBody
							};
						...
						if (i == num3)
						{
							drawData = new DrawData(value, vector, drawinfo.compFrontArmFrame, drawinfo.colorArmorBody, rotation, bodyVect, 1f, drawinfo.playerEffect, 0)
							{
								shader = drawinfo.cBody
							};
				...
				for (int j = 0; j < 2; j++)
				{
					if (j == num2)
					{
						...
						if (drawinfo.drawPlayer.head == 269)
						{
							...
							DrawData item = new DrawData(TextureAssets.Extra[214].Value, position2, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorHead, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
							item.shader = drawinfo.cHead;
							drawinfo.DrawDataCache.Add(item);
		...
		public static void DrawPlayer_36_CTG(ref PlayerDrawSet drawinfo)
		{
			...
			for (int j = 0; j < 7; j++)
			{
				...
				DrawData item = new DrawData(value, new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - 80f)) + vector2 * vector * num3, null, new Color(250, 250, 250, (int)Main.mouseTextColor / 2), 0f, value.Size() / 2f, ((float)(int)Main.mouseTextColor / 1000f + 0.8f) * num7, SpriteEffects.None, 0);
				list.Add(item);
			}
			if (flag)
			{
		...
		public static void DrawPlayer_38_EyebrellaCloud(ref PlayerDrawSet drawinfo)
		{
			if (drawinfo.drawPlayer.eyebrellaCloud && drawinfo.shadow == 0f)
			{
				...
				Vector2 vector2 = drawinfo.drawPlayer.RotatedRelativePoint(drawinfo.drawPlayer.MountedCenter - new Vector2(0f, (float)drawinfo.drawPlayer.height * 0.5f) + new Vector2(0f, -30f) + vector, reverseRotation: true) - Main.screenPosition;
				...
				float num3 = 3f;
				float rotation = 0f - drawinfo.rotation;
				DrawData item;
				for (int i = 0; i < 2; i++)
				{
					Vector2 vector3 = new Vector2((i == 0) ? (0f - num3) : num3, 0f).RotatedBy(num2 * ((float)Math.PI * 2f) * ((i == 0) ? 1f : (-1f)));
					item = new DrawData(value, vector2 + vector3, value2, color2 * 0.65f, rotation, origin, 1f, (drawinfo.drawPlayer.gravDir == -1f) ? SpriteEffects.FlipVertically : SpriteEffects.None, 0);
					item.shader = drawinfo.cHead;
					drawinfo.DrawDataCache.Add(item);
				}
				item = new DrawData(value, vector2, value2, color2, rotation, origin, 1f, (drawinfo.drawPlayer.gravDir == -1f) ? SpriteEffects.FlipVertically : SpriteEffects.None, 0);
				item.shader = drawinfo.cHead;
				drawinfo.DrawDataCache.Add(item);
			}
		}
